// Configuration: with-extrapolate-varying
// Draw config: segments-insertcaps
//
// Shader options:
//   debug: false
//   insertCaps: true
...
//   endpointCount: 0
//
// This shader is for line segments
//
...
attribute vec2 xyA, xyB, xyC, xyD;
...
vec4 pD = getPosition(xyD);
  ...
  pA = vec4(vec3(pA.xy * _resolution, pA.z) / pA.w, 1);
