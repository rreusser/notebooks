// Sphere eversion drawing command for regl
// Implements the Bednorz & Bednorz analytic sphere eversion
...
export function createDrawSphere(regl, resolution = 150) {
  const mesh = createMeshSurface({
    resolution: [resolution, resolution],
    uDomain: [-PI * 0.5 * FUDGE, PI * 0.5 * FUDGE],
    vDomain: [-PI * FUDGE, PI * FUDGE],
  });
