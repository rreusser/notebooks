...
</figure>`},inputs:["html","FileAttachment"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});m({root:document.getElementById("cell-526"),expanded:[],variables:[]},{id:526,body:t=>t("1392357775666159618"),inputs:["tweet"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-610"),expanded:[],variables:[]},{id:610,body:(t,e,a)=>{t==="half float"&&e(a`<p style="color:#a00">Warning! This simulation is using half-float precision and as a result won't be accurate. Try a device which supports the floating point WebGL textures for better results.</p>`)},inputs:["colorType","display","html"],outputs:[],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-289"),expanded:[],variables:[]},{id:289,body:(t,e,a,i,n,o,u,d,c,f,_,s,r,l)=>{const h=t`<figure>
  ${e.element}
  <figcaption>Hover to view pendulum. Scroll to zoom, drag to pan.</figcaption>
</figure>`;return a(i(h,{width:Math.min(n,640),height:Math.min(n,640),toggleOffset:[-6,-33],controls:".pendulum-controls",onResize(g,y,v){e.resize(y,v),o.updateScales(e.elements.plot.scale("x"),e.elements.plot.scale("y"));const p=u(o.xDomain,o.yDomain,y,v);d.x[0]=p.x[0],d.x[1]=p.x[1],d.y[0]=p.y[0],d.y[1]=p.y[1],c(y,v),f.poll(),_[0].use(()=>s(()=>{r({...l,debugCheckerboard:!1})})),f.dirty=!0}})),{figure:h}},inputs:["html","stack","display","expandable","width","axes","computeTextureDomain","textureDomain","resizeFBOs","regl","y","blit","initialize","params"],outputs:["figure"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-914"),expanded:[],variables:[]},{id:914,body:(t,e,a,i)=>{const n=t`<div class="pendulum-controls"></div>`;function o(v){return n.appendChild(v),e.input(v)}const u=o(a.range([.1,1],{label:"Mass 1 (m₁)",value:1,step:.01,transform:Math.log})),d=o(a.range([.1,1],{label:"Mass 2 (m₂)",value:1,step:.01,transform:Math.log})),c=o(a.range([.1,1],{label:"Length 1 (l₁)",value:1,step:.01,transform:Math.log})),f=o(a.range([.1,1],{label:"Length 2 (l₂)",value:1,step:.01,transform:Math.log})),_=o(a.range([-2,2],{label:"Initial angular velocity of arm 1",value:0})),s=o(a.range([-2,2],{label:"Initial angular velocity of arm 2",value:0})),r=o(a.range([.001,.1],{label:"Time step",value:.03,transform:Math.log})),l=o(a.radio(["Simple","Compound"],{label:"Pendulum type",value:"Compound"})),h=o(a.checkbox(["Simulate","Show pendulum at point under mouse"],{value:["Simulate","Show pendulum at point under mouse"]})),g=o(a.button("Reset View")),y=o(a.button("Restart"));return i(n),{controlsContainer:n,ctrl:o,m1:u,m2:d,l1:c,l2:f,omega0_0:_,omega0_1:s,dt:r,pendulumType:l,simulate:h,resetView:g,restart:y}},inputs:["html","Generators","Inputs","display"],outputs:["controlsContainer","ctrl","m1","m2","l1","l2","omega0_0","omega0_1","dt","pendulumType","simulate","resetView","restart"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-915"),expanded:[],variables:[]},{id:915,body:()=>({params:{omega0_0:0,omega0_1:0,pendulumType:"Compound",m1:1,m2:1,l1:1,l2:1}}),inputs:[],outputs:["params"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-916"),expanded:[],variables:[]},{id:916,body:(t,e,a,i,n,o,u,d)=>{t.omega0_0=e,t.omega0_1=a,t.pendulumType=i,t.m1=n,t.m2=o,t.l1=u,t.l2=d},inputs:["params","omega0_0","omega0_1","pendulumType","m1","m2","l1","l2"],outputs:[],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-919"),expanded:[],variables:[]},{id:919,body:t=>{function e(a,i,n=[-Math.PI,Math.PI],o=[-Math.PI,Math.PI]){return t.plot({width:a,height:i,marginTop:20,marginRight:10,marginLeft:50,marginBottom:40,style:{backgroundColor:"transparent",maxWidth:"none",position:"absolute"},x:{domain:n,tickSpacing:80,label:"θ₁",labelAnchor:"center"},y:{domain:o,tickSpacing:80,label:"θ₂",labelAnchor:"center"},marks:[]})}return{createPlot:e}},inputs:["Plot"],outputs:["createPlot"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-920"),expanded:[],variables:[]},{id:920,body:(t,e,a,i,n)=>({stack:t({layers:[{id:"regl",element:e(a,{optionalExtensions:["OES_texture_half_float","OES_texture_float","OES_texture_float_linear","OES_texture_half_float_linear","ANGLE_instanced_arrays"],attributes:{antialias:!0,alpha:!1,depthStencil:!1,preserveDrawingBuffer:!0}})},{id:"plot",element:({width:u,height:d})=>i(u,d)},{id:"svg",element:({current:u,width:d,height:c})=>(u?n.select(u):n.create("svg")).attr("width",d).attr("height",c).style("position","absolute").node()}]})}),inputs:["createElementStack","reglElement","createREGL","createPlot","d3"],outputs:["stack"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-5"),expanded:[],variables:[]},{id:5,body:t=>({regl:t.elements.regl.value}),inputs:["stack"],outputs:["regl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-921"),expanded:[],variables:[]},{id:921,body:(t,e,a,i,n,o,u,d,c,f,_)=>{let s=null;const r={x:[-Math.PI,Math.PI],y:[-Math.PI,Math.PI]},l={top:20,right:10,bottom:40,left:50};function h(p,b,x,E){const T=x-l.left-l.right,C=E-l.top-l.bottom,P=(p[1]-p[0])/T,I=(b[1]-b[0])/C;return{x:[p[0]-l.left*P,p[1]+l.right*P],y:[b[0]-l.bottom*I,b[1]+l.top*I]}}function g(){const p=h(v.xDomain,v.yDomain,t.width,t.height);e.x[0]=p.x[0],e.x[1]=p.x[1],e.y[0]=p.y[0],e.y[1]=p.y[1],a(t.width,t.height),i.poll(),n[0].use(()=>o(()=>{u({...d,debugCheckerboard:!1})})),i.dirty=!0}function y(){const p=h(r.x,r.y,t.width,t.height);e.x[0]=p.x[0],e.x[1]=p.x[1],e.y[0]=p.y[0],e.y[1]=p.y[1],v.reset()}const v=c({d3:f,element:t.elements.svg,xScale:t.elements.plot.scale("x"),yScale:t.elements.plot.scale("y"),aspectRatio:1,scaleExtent:[.1,1e3],onChange:({xDomain:p,yDomain:b})=>{i.dirty=!0;const x=_(t.width,t.height,p,b);t.elements.plot.replaceWith(x),t.elements.plot=x,t.dispatchEvent(new CustomEvent("update")),clearTimeout(s),s=setTimeout(g,300)}});return{reinitTimeout:s,baselineDomain:r,margins:l,computeTextureDomain:h,reinitialize:g,resetToBaseline:y,axes:v}},inputs:["stack","textureDomain","resizeFBOs","regl","y","blit","initialize","params","createZoomableAxes","d3","createPlot"],outputs:["reinitTimeout","baselineDomain","margins","computeTextureDomain","reinitialize","resetToBaseline","axes"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-922"),expanded:[],variables:[]},{id:922,body:(t,e)=>{t>0&&e()},inputs:["resetView","resetToBaseline"],outputs:[],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-158"),expanded:[],variables:[]},{id:158,body:(t,e,a,i,n,o,u,d,c,f,_,s,r,l,h,g,y,v)=>{const p=c(f.xDomain,f.yDomain,_.width,_.height);return s.x[0]=p.x[0],s.x[1]=p.x[1],s.y[0]=p.y[0],s.y[1]=p.y[1],r(_.width,_.height),l.poll(),h[0].use(()=>g(()=>{y({...v,debugCheckerboard:!1})})),{extended:p,initialized:!0}},inputs:["restart","pendulumType","omega0_0","omega0_1","m1","m2","l1","l2","computeTextureDomain","axes","stack","textureDomain","resizeFBOs","regl","y","blit","initialize","params"],outputs:["extended","initialized"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-54"),expanded:[],variables:[]},{id:54,body:(t,e,a,i,n,o,u,d,c,f,_,s,r,l,h,g,y)=>{const p=~u.indexOf("Simulate"),b=~u.indexOf("Show pendulum at point under mouse"),x=d==="Compound";c.dirty=!0;const E=c.frame(()=>{f(()=>{(c.dirty||p)&&c.clear({color:[1,1,1,1]}),p&&_([{dt:s,src:r[0],dst:r[1],isCompound:x,m1:a,m2:i,l1:n,l2:o},{dt:s,src:r[1],dst:r[0],isCompound:x,m1:a,m2:i,l1:n,l2:o}]),(c.dirty||p)&&(l(),b&&h.active&&g({state:r[0],l1:n,l2:o,isCompound:x}),c.dirty=!1)})});return y.then(()=>E.cancel()),{DEBUG_CHECKERBOARD:!1,run:p,showPen:b,isCompound:x,frame:E}},inputs:["initialized","restart","m1","m2","l1","l2","simulate","pendulumType","regl","blit","update","dt","y","drawMap","mouseHover","drawPendulum","invalidation"],outputs:["DEBUG_CHECKERBOARD","run","showPen","isCompound","frame"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-78"),expanded:[],variables:[]},{id:78,body:(t,e)=>({colorType:t(e,"float")?"float":t(e,"half float")?"half float":"uint8"}),inputs:["canWriteToFBOOfType","regl"],outputs:["colorType"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-923"),expanded:[],variables:[]},{id:923,body:()=>({textureDomain:{x:[-Math.PI,Math.PI],y:[-Math.PI,Math.PI]}}),inputs:[],outputs:["textureDomain"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-58"),expanded:[],variables:[]},{id:58,body:(t,e,a,i,n)=>{const o=Math.round(t.width*e),u=Math.round(t.height*e),d=a==="float"&&i.hasExtension("OES_texture_float_linear")||a==="half float"&&i.hasExtension("OES_texture_half_float_linear")||a==="uint8",c="nearest",f=function(){const s=[0,1].map(()=>i.framebuffer({color:i.texture({width:o,height:u,type:a,wrap:"clamp",min:c,mag:c}),depth:!1,stencil:!1}));return n.then(()=>s.forEach(r=>r.destroy())),s}();function _(s,r){const l=Math.round(s*e),h=Math.round(r*e);(f[0].width!==l||f[0].height!==h)&&(f[0].resize(l,h),f[1].resize(l,h))}return{initialWidth:o,initialHeight:u,supportsLinearFilter:d,filterMode:c,y:f,resizeFBOs:_}},inputs:["stack","pixelRatio","colorType","regl","invalidation"],outputs:["initialWidth","initialHeight","supportsLinearFilter","filterMode","y","resizeFBOs"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});m({root:document.getElementById("cell-113"),expanded:[],variables:[]},{id:113,body:t=>({blit:t({vert:`
