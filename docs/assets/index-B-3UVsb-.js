import{_ as I,d}from"./index-Bvdv0JJ6.js";(window.location.hostname==="localhost"||window.location.hostname.match(/127\.0\.0\.1/))&&I(async()=>{const{main:e}=await import("./index-Bvdv0JJ6.js").then(t=>t.i);return{main:e}},[]).then(({main:e})=>{window.__observableRuntime=e,console.log("[DebugClient] Runtime module exposed as window.__observableRuntime"),I(()=>import("./debug-client-BJyqFSh-.js"),[])});d({root:document.getElementById("cell-1771"),expanded:[],variables:[]},{id:1771,body:(e,t)=>e`The [Baily-Borwein-Plouffe](https://en.wikipedia.org/wiki/Bailey%E2%80%93Borwein%E2%80%93Plouffe_formula) (BBP) formula is a remarkable formula for computing the hexadecimal digits of ${t`\pi`}, starting at the ${t`n^{th}`} digit, *without first computing preceeding digits*!`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1820"),expanded:[],variables:[]},{id:1820,body:e=>e.block`\pi =\sum _{k=0}^{\infty }\left[{\frac {1}{16^{k}}}\left({\frac {4}{8k+1}}-{\frac {2}{8k+4}}-{\frac {1}{8k+5}}-{\frac {1}{8k+6}}\right)\right].`,inputs:["tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1770"),expanded:[],variables:[]},{id:1770,body:(e,t)=>e`That such a formula could exist is a bit shocking—though the initial shock is tempered by the realization that it does, of course, take longer as you start at later digits (${t`O(n \log n)`} as a function of the starting digit, to be precise). Additionally, the hexadecimal digits cannot be converted to decimal without first computing all of the leading digits. What it does enable though, is to compute digits deep into ${t`\pi`} with hardly any memory consumption and nothing more than a basic double precision data type.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1193"),expanded:[],variables:[]},{id:1193,body:function*(t,i,a){if(!this){yield t`Click to compute π starting at the millionth hexadecimal digit.`;return}yield t`Computing…`;const n=performance.now(),o=10,u=a(1e6,o),c=performance.now();yield t`<div>
  ...
  </div>`},inputs:["html","recompute","computePi"],outputs:void 0,output:"viewof$dummy",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});d({root:document.getElementById("cell-1242"),expanded:[],variables:[]},{id:1242,body:(e,t)=>({recompute:e(t.button("Compute"))}),inputs:["view","Inputs"],outputs:["recompute"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1774"),expanded:[],variables:[]},{id:1774,body:(e,t)=>e`The table below shows hexadecimal digits of ${t`\pi`}. Each line represents an independent run of the algorithm starting at a slightly different digit. Green digits are correctly computed digits, while red represents incorrect digits. Due to our termination criteria, we usually get a couple fewer digits than requested.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-805"),expanded:[],variables:[]},{id:805,body:(e,t)=>({method:e(t.radio(["Floating point","BigInt"],{label:"Data type",value:"Floating point"}))}),inputs:["view","Inputs"],outputs:["method"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-333"),expanded:[],variables:[]},{id:333,body:(e,t,i)=>({startingDigit:e(t.range([0,i.referenceDigits.length-128],{value:0,label:"Starting digit",step:1}))}),inputs:["view","Inputs","reference"],outputs:["startingDigit"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-437"),expanded:[],variables:[]},{id:437,body:(e,t,i)=>({digits:e(t.range([2,i==="Floating point"?14:128],{label:"Digits to compute",value:i==="Floating point"?14:128,step:1}))}),inputs:["view","Inputs","method"],outputs:["digits"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1821"),expanded:[],variables:[]},{id:1821,body:e=>({figureWidth:Math.min(950,window.innerWidth+1e-8*e)}),inputs:["width"],outputs:["figureWidth"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-478"),expanded:[],variables:[]},{id:478,body:function*(t,i,a,n,o,u,c,b,s){const r=Math.floor((t-90)/850*128),f=i.referenceDigits.slice(a,a+r);function E(m,l,h){const y=document.createElement("span"),w=document.createElement("span");w.textContent=a===0&&h>0?f[0]+"."+f.slice(1,h):f.slice(0,h),y.appendChild(w),y.style.color="#ccc";for(let g=0;g<f.length-h;g++){const p=document.createElement("span");p.textContent=l[g],y.appendChild(p);const B=m[g]===l[g]?"rgb(32, 165, 186)":"#c12";if(p.style.color=B,p.style.fontWeight=900,a===0&&h===0&&g===0){const k=document.createElement("span");k.textContent=".",k.style.color=B,y.appendChild(k)}}const v=document.createElement("span");return v.textContent=f.slice(h+n,f.length),y.appendChild(v),y.style.color="#bbb",y}const x=[],_=a===0?f[0]+"."+f.slice(1):f;for(let m=a;m<a+f.length;m+=4){const l=document.createElement("code");l.style.fontSize="inherit",l.style.color="#ccc",l.textContent=_,x.push(l)}const $=x.map(m=>o`<code style="font-size:inherit;">${m}</code><br>`),P=Math.min(0,-(t-40-u)/2),S=o`
    <pre style="padding:0;font-size:${11}px;background:white;width:${t}px;margin-left:${P}px">
${$}</pre>
  `,C=c==="Floating point"?b:s;for(let m=0,l=a;l<a+f.length;m++,l+=4){const h=performance.now(),y=C(l,n),w=performance.now(),v=y.toString(16).padStart(n,"0"),g=E(i.referenceDigits.slice(l,l+n),v,l-a),p=document.createElement("code");p.style.fontSize="inherit",p.style.color="rgb(32, 165, 186)",p.style.fontWeight="700",p.textContent=` (${(w-h).toFixed(1)}ms)`,g.appendChild(p),x[m].replaceWith(g),yield S}},inputs:["figureWidth","reference","startingDigit","digits","html","width","method","computePi","computePiBigInt"],outputs:void 0,output:"table",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1822"),expanded:[],variables:[]},{id:1822,body:function(){return{referenceDigits:`
...
`).join("")}},inputs:[],outputs:void 0,output:"reference",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1779"),expanded:[],variables:[]},{id:1779,body:(e,t)=>e`So let's walk through using the identity to compute ${t`\pi`} starting at an arbitrary location. I'll largely repeat the eponymous David Bailey's explanation from *[The BBP Algorithm for Pi](https://www.davidhbailey.com/dhbpapers/bbp-alg.pdf)*, filling in some details I learned along the way. The implemenation is also heavily influenced by the version from [literateprograms.org](https://literateprograms.org/pi_with_the_bbp_formula__python_.html).`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1781"),expanded:[],variables:[]},{id:1781,body:e=>e.block`\pi =\sum_{k=0}^{\infty }\left[{\frac {1}{16^{k}}}\left({\frac {4}{8k+1}}-{\frac {2}{8k+4}}-{\frac {1}{8k+5}}-{\frac {1}{8k+6}}\right)\right].`,inputs:["tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1782"),expanded:[],variables:[]},{id:1782,body:(e,t)=>e`We first multiply through by ${t`16^d`}, then take the fractional part (modulo 1, if you prefer) which we denote by ${t`\{\cdot\}.`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1783"),expanded:[],variables:[]},{id:1783,body:e=>e.block`\{16^d\pi\} = \left\{\sum _{k=0}^{\infty }\left(
{\frac {16^{d-k} 4}{8k+1}}-
{\frac {16^{d-k} 2}{8k+4}}-
{\frac {16^{d-k}}{8k+5}}-
{\frac {16^{d-k}}{8k+6}}
\right)\right\}`,inputs:["tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1784"),expanded:[],variables:[]},{id:1784,body:(e,t)=>e`Consider ${t`d = 4`} (starting at the fourth digit):`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1785"),expanded:[],variables:[]},{id:1785,body:e=>e.block`\begin{aligned}
...
\end{aligned}`,inputs:["tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1786"),expanded:[],variables:[]},{id:1786,body:(e,t)=>e`In hexadecimal, ${t`16^d`} shifts the value ${t`d`} places to the left (analogous to multiplication by ten in base ten), while the fractional part operation chops off any leading digits to the left of the [radix point](https://en.wikipedia.org/wiki/Radix_point). Thus, it pretty directly gives us the hexadecimal representation of ${t`\pi`} starting at the ${t`d^{th}`} digit.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1787"),expanded:[],variables:[]},{id:1787,body:(e,t)=>e`If we then multiply by ${t`16^n`} and take the integer part, we obtain ${t`n`} digits of ${t`\pi`}, starting at digit ${t`d`}. Consider ${t`n = 6`}:`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1788"),expanded:[],variables:[]},{id:1788,body:e=>e.block`\begin{aligned}
...
`},inputs:["md","tex"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-829"),expanded:[],variables:[]},{id:829,body:()=>{function e(t,i){return t%=i,t<0?t+i:t}return{mod:e}},inputs:[],outputs:["mod"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1501"),expanded:[],variables:[]},{id:1501,body:(e,t)=>e`The function below directly implements the above summation ${t`S_j`} and the function \`computePi(d, n)\` which starts at digit ${t`d`} and computes ${t`n`} digits of ${t`\pi`}. It returns the result as an integer JavaScript \`Number\` so that we'll need to run \`.toString(16)\` to convert the output to hexadecimal.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-792"),expanded:[],variables:[]},{id:792,body:(e,t)=>{function i(n,o){let u=0;for(let b=0;b<=o;b++){let s=8*b+n;u=e(u+t(16,o-b,s)/s,1)}let c=0;for(let b=o+1;;b++){let s=c+16**(o-b)/(8*b+n);if(c===s)break;c=s}return u+c}function a(n,o){return n-=1,Math.floor(16**o*e(4*i(1,n)-2*i(4,n)-i(5,n)-i(6,n),1))}return{S:i,computePi:a}},inputs:["mod","modPow"],outputs:["S","computePi"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1768"),expanded:[],variables:[]},{id:1768,body:e=>e(0,10).toString(16),inputs:["computePi"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1512"),expanded:[],variables:[]},{id:1512,body:function(e){return e`## BigInt implementation`},inputs:["md"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1769"),expanded:[],variables:[]},{id:1769,body:()=>{function e(a,n,o){if(!n)return 1n;a=a%o;let u=1n;for(;;){if(n&1n&&(u=u*a%o),n>>=1n,!n)return u;a=a*a%o}}function t(a,n,o,u){const c=o<<2n;let b=0n;for(let r=0n;r<=n;r++){let f=r*8n+a;b=b+(e(16n,n-r,f)<<c)/f&u}let s=0n;for(let r=n+1n;;r++){let f=s+16n**(o+n-r)/(r*8n+a);if(s===f)break;s=f}return b+s}function i(a,n){const o=BigInt(n),u=BigInt(a)-1n,c=16n**o-1n;return 4n*t(1n,u,o,c)-2n*t(4n,u,o,c)-t(5n,u,o,c)-t(6n,u,o,c)&c}return{modPowBigInt:e,SBigInt:t,computePiBigInt:i}},inputs:[],outputs:["modPowBigInt","SBigInt","computePiBigInt"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1739"),expanded:[],variables:[]},{id:1739,body:function(e){return e`The article from literateprograms.org, [Pi with the BBP formula](https://literateprograms.org/pi_with_the_bbp_formula__python_.html), notes that there's an additional, more efficient variation that generates digits sequentially, but since it requires a rational data type, I've not implemented it.`},inputs:["md"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1521"),expanded:[],variables:[]},{id:1521,body:function(e){return e`## References
