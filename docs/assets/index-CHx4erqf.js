...
\end{aligned}`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-45"),expanded:[],variables:[]},{id:45,body:(a,t)=>a`The term in parentheses contains factors of ${t`\frac{i}{\omega}`}, which corresponds to time integration. In other words, in additon to integrating the other state variables in time, we need to integrate one more. We define the term in parentheses as the auxiliary quantity ${t`\psi,`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-46"),expanded:[],variables:[]},{id:46,body:(a,t)=>a`${t.block`\psi = \frac{ic\sigma_x}{\omega} \frac{\partial v_y}{\partial y} + \frac{ic\sigma_y}{\omega} \frac{\partial v_x}{\partial x} - \frac{i}{\omega} \sigma_x \sigma_y u`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-47"),expanded:[],variables:[]},{id:47,body:(a,t)=>a`Multiplying through by ${t`-i\omega`} and transforming back to the time domain gives

${t.block`\frac{d\psi}{dt} = c \sigma_x \frac{\partial v_y}{\partial y} + c \sigma_y \frac{\partial v_x}{\partial x} - \sigma_x \sigma_y u`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-48"),expanded:[],variables:[]},{id:48,body:(a,t)=>a`The update equation for ${t`u`} then becomes
...
\frac{\partial v_x}{\partial t} &= c \frac{\partial u}{\partial x} - \sigma_x v_x \\[10pt]
\frac{\partial v_y}{\partial t} &= c \frac{\partial u}{\partial y} - \sigma_y v_y
\end{aligned}`}`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-49"),expanded:[],variables:[]},{id:49,body:(a,t)=>a`These equations require tracking three fields: the scalar field ${t`u`}, the auxiliary field ${t`\psi`}, and the vector field ${t`\mathbf{v} = (v_x, v_y)`}. In practice, this naturally lends itself to a two-buffer implementation: one storing ${t`(u, \psi)`} and the other storing ${t`(v_x, v_y)`}. The two buffers are offset by half a timestep to avoid some of the common instabilities encountered when simulating wave equations.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-50"),expanded:[],variables:[]},{id:50,body:(a,t)=>a`The following WebGL implementation simulates these equations on the GPU using fragment shaders. Use the controls below to pause/resume the simulation, adjust contrast, and visualize the PML absorption regions (red for ${t`\sigma_x`}, green for ${t`\sigma_y`}).`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});s({root:document.getElementById("cell-17"),expanded:[],variables:[]},{id:17,body:a=>{const t=a`<canvas width="640" height="640" style="width: 100%; height: auto; display: block; image-rendering: pixelated; touch-action: none;"></canvas>`,i=t.getContext("webgl2");if(!i)throw new Error("WebGL 2 is not supported");const A=i.getExtension("EXT_color_buffer_float");if(!A)throw new Error("EXT_color_buffer_float extension is not supported");const M=12,W=2,d=1,D=4,e=10,h=1,m=.5,y=1,L=`#version 300 es
    in vec2 a_position;
    void main() {
  ...
  `;function c(u,p){const l=i.createShader(p);if(i.shaderSource(l,u),i.compileShader(l),!i.getShaderParameter(l,i.COMPILE_STATUS)){const b=i.getShaderInfoLog(l);throw console.error("Shader compilation error:",b),console.error("Shader source:",u),i.deleteShader(l),new Error("Shader compilation failed: "+b)}return l}function P(u,p){const l=c(u,i.VERTEX_SHADER),b=c(p,i.FRAGMENT_SHADER),S=i.createProgram();if(i.attachShader(S,l),i.attachShader(S,b),i.linkProgram(S),!i.getProgramParameter(S,i.LINK_STATUS)){const O=i.getProgramInfoLog(S);throw console.error("Program linking error:",O),new Error("Program linking failed: "+O)}return S}const w=P(L,T),I=P(L,E),B=P(L,C),U=i.createBuffer();i.bindBuffer(i.ARRAY_BUFFER,U),i.bufferData(i.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),i.STATIC_DRAW);function R(u,p){const l=i.createTexture();i.bindTexture(i.TEXTURE_2D,l),i.texImage2D(i.TEXTURE_2D,0,i.RGBA32F,u,p,0,i.RGBA,i.FLOAT,null),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,i.NEAREST),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE);const b=i.createFramebuffer();return i.bindFramebuffer(i.FRAMEBUFFER,b),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,l,0),{fbo:b,texture:l}}const x=t.width,g=t.height,_=[R(x,g),R(x,g)],$=[R(x,g),R(x,g)];let N=0;const n=[],o={x:-1e3,y:-1e3,lastMoveTime:-1e4,isMoving:!1,isActive:!1};t.addEventListener("pointerenter",u=>{const p=t.getBoundingClientRect(),l=(u.clientX-p.left)*x/p.width,b=g-(u.clientY-p.top)*g/p.height;n.push({x:l,y:b,time:performance.now()})}),t.addEventListener("pointermove",u=>{const p=t.getBoundingClientRect(),l=(u.clientX-p.left)*x/p.width,b=g-(u.clientY-p.top)*g/p.height;n.push({x:l,y:b,time:performance.now()})}),t.addEventListener("pointerleave",u=>{o.x=-1e3,o.y=-1e3,o.lastMoveTime=-1e4,o.isMoving=!1,o.isActive=!1});const F={usePsi:1,showSigma:0,contrast:.454,pmlWidth:12,mouseX:-1e3,mouseY:-1e3,mouseMoving:0,mouseActive:0};return{canvas:t,gl:i,ext:A,PML_WIDTH:M,PML_EXPONENT:W,PML_STRENGTH:d,OSCILLATOR_STRENGTH:D,OSCILLATOR_WAVELENGTH:e,C:h,DT:m,DX:y,vertexShaderSource:L,commonSource:f,bufferASource:T,bufferBSource:E,displaySource:C,compileShader:c,createProgram:P,bufferAProgram:w,bufferBProgram:I,displayProgram:B,quadBuffer:U,createFramebuffer:R,width:x,height:g,bufferA:_,bufferB:$,currentBuffer:N,pointerQueue:n,mouseState:o,uniforms:F,webgl_setup:{canvas:t,gl:i,width:x,height:g,bufferAProgram:w,bufferBProgram:I,displayProgram:B,quadBuffer:U,bufferA:_,bufferB:$,mouseState:o,uniforms:F}}},inputs:["html"],outputs:["canvas","gl","ext","PML_WIDTH","PML_EXPONENT","PML_STRENGTH","OSCILLATOR_STRENGTH","OSCILLATOR_WAVELENGTH","C","DT","DX","vertexShaderSource","commonSource","bufferASource","bufferBSource","displaySource","compileShader","createProgram","bufferAProgram","bufferBProgram","displayProgram","quadBuffer","createFramebuffer","width","height","bufferA","bufferB","currentBuffer","pointerQueue","mouseState","uniforms","webgl_setup"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-18"),expanded:[],variables:[]},{id:18,body:(a,t,i,A,M)=>{a.uniforms.usePsi=t?1:0,a.uniforms.showSigma=i?1:0,a.uniforms.contrast=Math.max(100**A,.1),a.uniforms.pmlWidth=M},inputs:["webgl_setup","usePsi","showSigma","contrast","pmlWidth"],outputs:[],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-19"),expanded:[],variables:[]},{id:19,body:(a,t,i,A,M,W,d)=>{const{canvas:D,gl:e,width:h,height:m,bufferAProgram:y,bufferBProgram:L,displayProgram:f,quadBuffer:T,bufferA:E,bufferB:C,uniforms:c}=a;let P=0,w,I=!1;function B(){if(!I)return;const R=performance.now();for(;t.length>0;){const _=t.shift();i.x=_.x,i.y=_.y,i.lastMoveTime=_.time}const x=R-i.lastMoveTime;if(i.isMoving=x<100,i.isActive=x<6e3,c.mouseX=i.x,c.mouseY=i.y,c.mouseMoving=i.isMoving?1:0,c.mouseActive=i.isActive?1:0,!A){e.bindFramebuffer(e.FRAMEBUFFER,null),e.viewport(0,0,h,m),e.useProgram(f);const _=e.getAttribLocation(f,"a_position");e.bindBuffer(e.ARRAY_BUFFER,T),e.enableVertexAttribArray(_),e.vertexAttribPointer(_,2,e.FLOAT,!1,0,0),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,E[P].texture),e.uniform1i(e.getUniformLocation(f,"u_bufferA"),0),e.uniform2f(e.getUniformLocation(f,"u_resolution"),h,m),e.uniform1f(e.getUniformLocation(f,"u_showSigma"),c.showSigma),e.uniform1f(e.getUniformLocation(f,"u_contrast"),c.contrast),e.uniform1f(e.getUniformLocation(f,"u_pmlWidth"),c.pmlWidth),e.drawArrays(e.TRIANGLE_STRIP,0,4),w=requestAnimationFrame(B);return}for(let _=0;_<2;_++){const $=P,N=1-P;e.bindFramebuffer(e.FRAMEBUFFER,E[N].fbo),e.viewport(0,0,h,m),e.useProgram(y);const n=e.getAttribLocation(y,"a_position");e.bindBuffer(e.ARRAY_BUFFER,T),e.enableVertexAttribArray(n),e.vertexAttribPointer(n,2,e.FLOAT,!1,0,0),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,E[$].texture),e.uniform1i(e.getUniformLocation(y,"u_bufferA"),0),e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,C[$].texture),e.uniform1i(e.getUniformLocation(y,"u_bufferB"),1),e.uniform2f(e.getUniformLocation(y,"u_resolution"),h,m),e.uniform1f(e.getUniformLocation(y,"u_pmlWidth"),c.pmlWidth),e.uniform1f(e.getUniformLocation(y,"u_usePsi"),c.usePsi),e.uniform1f(e.getUniformLocation(y,"u_mouseX"),c.mouseX),e.uniform1f(e.getUniformLocation(y,"u_mouseY"),c.mouseY),e.uniform1f(e.getUniformLocation(y,"u_mouseMoving"),c.mouseMoving),e.uniform1f(e.getUniformLocation(y,"u_mouseActive"),c.mouseActive),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.bindFramebuffer(e.FRAMEBUFFER,C[N].fbo),e.useProgram(L);const o=e.getAttribLocation(L,"a_position");e.bindBuffer(e.ARRAY_BUFFER,T),e.enableVertexAttribArray(o),e.vertexAttribPointer(o,2,e.FLOAT,!1,0,0),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,E[N].texture),e.uniform1i(e.getUniformLocation(L,"u_bufferA"),0),e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,C[$].texture),e.uniform1i(e.getUniformLocation(L,"u_bufferB"),1),e.uniform2f(e.getUniformLocation(L,"u_resolution"),h,m),e.uniform1f(e.getUniformLocation(L,"u_pmlWidth"),c.pmlWidth),e.drawArrays(e.TRIANGLE_STRIP,0,4),P=N}e.bindFramebuffer(e.FRAMEBUFFER,null),e.viewport(0,0,h,m),e.useProgram(f);const g=e.getAttribLocation(f,"a_position");e.bindBuffer(e.ARRAY_BUFFER,T),e.enableVertexAttribArray(g),e.vertexAttribPointer(g,2,e.FLOAT,!1,0,0),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,E[P].texture),e.uniform1i(e.getUniformLocation(f,"u_bufferA"),0),e.uniform2f(e.getUniformLocation(f,"u_resolution"),h,m),e.uniform1f(e.getUniformLocation(f,"u_showSigma"),c.showSigma),e.uniform1f(e.getUniformLocation(f,"u_contrast"),c.contrast),e.uniform1f(e.getUniformLocation(f,"u_pmlWidth"),c.pmlWidth),e.drawArrays(e.TRIANGLE_STRIP,0,4),w=requestAnimationFrame(B)}const U=new M(R=>{R.forEach(x=>{I=x.isIntersecting,I?w||(w=requestAnimationFrame(B)):w&&(cancelAnimationFrame(w),w=null)})});return U.observe(D),W.then(()=>{w&&cancelAnimationFrame(w),U.disconnect()}),d(D),{canvas:D,gl:e,width:h,height:m,bufferAProgram:y,bufferBProgram:L,displayProgram:f,quadBuffer:T,bufferA:E,bufferB:C,uniforms:c,currentBuffer:P,animationId:w,isVisible:I,render:B,observer:U}},inputs:["webgl_setup","pointerQueue","mouseState","simulate","IntersectionObserver","invalidation","display"],outputs:["canvas","gl","width","height","bufferAProgram","bufferBProgram","displayProgram","quadBuffer","bufferA","bufferB","uniforms","currentBuffer","animationId","isVisible","render","observer"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-20"),expanded:[],variables:[]},{id:20,body:(a,t)=>{const i=a(t.toggle({label:"Simulate",value:!0})),A=a(t.toggle({label:"Use auxiliary ψ equation",value:!0})),M=a(t.toggle({label:"Show absorption regions",value:!1})),W=a(t.range([0,1],{label:"Contrast",step:.01,value:0})),d=a(t.range([4,40],{label:"PML width (pixels)",step:1,value:12}));return{simulate:i,usePsi:A,showSigma:M,contrast:W,pmlWidth:d}},inputs:["view","Inputs"],outputs:["simulate","usePsi","showSigma","contrast","pmlWidth"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});
