function K(x,{width:C,height:N,toggleOffset:v=[8,8],onResize:w,controls:E}){let p=!1,M=C,P=N,h=!1,a={x:16,y:16},i=null,f=!1,y={x:0,y:0};const L=E?Array.isArray(E)?E:[E]:[],g=[];let m=null;const d=document.createElement("div");d.className="expandable-container",d.style.cssText=`
    position: relative;
    width: 100%;
