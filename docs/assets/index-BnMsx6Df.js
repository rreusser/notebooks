...
Recall that ${t`\mathrm{sech}(u) \equiv 1/\mathrm{cosh}(u).`} So in this sense they sort of interpolate between the [trigonometric](https://en.wikipedia.org/wiki/Trigonometric_functions) and [hyperbolic](https://en.wikipedia.org/wiki/Hyperbolic_functions) functions. Very cool. See [Jacobi Elliptic Functions in the Complex Plane](https://observablehq.com/@rreusser/jacobi-elliptic-functions-in-the-complex-plane) for an even lovelier view of how this generalization works.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-769"),expanded:[],variables:[]},{id:769,body:(e,t,n,r,o,u,d,c,b,f,x)=>{let y;e<1?y=t(e):e===1?y=10:y=t(1/e)/Math.sqrt(e);const m=501,k=[...Array(m).keys()].map(a=>(a/(m-1)*5-.5)*y),$=k.map(a=>{const l=a/y;let v,p,w;v=n(a,e),p=r(a,e),w=o(a,e);const M=u(a,e),K=p*p+(1-e)*v*v-w*w;return{am:M,uK:l,u:a,sn:v,cn:p,dn:w,am:M,checksum:K}});return d(c.html`<figure style="max-width:100%">${b.plot({width:Math.min(640,f),height:300,grid:!0,x:{label:"u / K →",ticks:4},y:{},marks:[b.ruleY([0]),b.line($,{x:"uK",y:"sn",stroke:"#c39"}),b.line($,{x:"uK",y:"cn",stroke:"#9c3"}),b.line($,{x:"uK",y:"dn",stroke:"#39c"})].filter(a=>a)})}<figcaption>
