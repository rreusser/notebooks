...
`;throw new Error(`Unsupported small R: ${e}`)}function Z(e,r){let t=1;for(;t*2<=r&&t*2<=e;)t*=2;const p=e/t;if(!Number.isInteger(p)||(p&p-1)!==0)throw new Error(`Cannot factor N=${e} with maxSize=${r}: R=${p} is not a power of 2`);return{R:p,C:t}}function ee(e,r,t=e.limits.maxComputeWorkgroupSizeX){const p=r>t,u=x(),i=e.createShaderModule({label:"Transpose",code:u}),a=e.createBindGroupLayout({label:"Transpose bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),b=e.createPipelineLayout({bindGroupLayouts:[a]}),m=e.createComputePipeline({label:"Transpose pipeline",layout:b,compute:{module:i,entryPoint:"transpose"}});if(!p){const q=y(r),D=e.createShaderModule({label:`Simple FFT N=${r}`,code:q}),C=e.createBindGroupLayout({label:"Simple FFT bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),H=e.createPipelineLayout({bindGroupLayouts:[C]});return{subRowFFT:null,twiddle:null,columnFFT:null,unscramble:null,scramble:null,simpleFFT:e.createComputePipeline({label:`Simple FFT pipeline N=${r}`,layout:H,compute:{module:D,entryPoint:"fft_horizontal"}}),transpose:m,bindGroupLayouts:{subRowFFT:null,twiddle:null,columnFFT:null,unscramble:null,scramble:null,simpleFFT:C,transpose:a},N:r,R:1,C:r,isLarge:!1}}const{R:l,C:s}=Z(r,t);console.log(`Large FFT: N=${r} = ${l}×${s}, maxWorkgroup=${t}`);const d=Y(s,l),n=J(),_=K(l,s),w=A(r,l,s),g=V(r,l,s),f=y(s),o=e.createShaderModule({label:`Sub-row FFT C=${s}`,code:d}),c=e.createShaderModule({label:`Twiddle N=${r}`,code:n}),S=e.createShaderModule({label:`Column FFT R=${l}`,code:_}),U=e.createShaderModule({label:`Unscramble N=${r}`,code:w}),B=e.createShaderModule({label:`Scramble N=${r}`,code:g}),k=e.createShaderModule({label:`Simple FFT C=${s}`,code:f}),F=e.createBindGroupLayout({label:"Sub-row FFT bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),P=e.createBindGroupLayout({label:"Twiddle bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),h=e.createBindGroupLayout({label:"Column FFT bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),T=e.createBindGroupLayout({label:"Simple FFT bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),G=e.createBindGroupLayout({label:"Unscramble bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),v=e.createBindGroupLayout({label:"Scramble bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),L=e.createPipelineLayout({bindGroupLayouts:[F]}),M=e.createPipelineLayout({bindGroupLayouts:[P]}),$=e.createPipelineLayout({bindGroupLayouts:[h]}),R=e.createPipelineLayout({bindGroupLayouts:[T]}),O=e.createPipelineLayout({bindGroupLayouts:[G]}),E=e.createPipelineLayout({bindGroupLayouts:[v]}),z=e.createComputePipeline({label:`Sub-row FFT pipeline C=${s}`,layout:L,compute:{module:o,entryPoint:"sub_row_fft"}}),j=e.createComputePipeline({label:`Twiddle pipeline N=${r}`,layout:M,compute:{module:c,entryPoint:"twiddle_multiply"}}),X=e.createComputePipeline({label:`Column FFT pipeline R=${l}`,layout:$,compute:{module:S,entryPoint:"column_fft"}}),N=e.createComputePipeline({label:`Simple FFT pipeline C=${s}`,layout:R,compute:{module:k,entryPoint:"fft_horizontal"}}),W=e.createComputePipeline({label:`Unscramble pipeline N=${r}`,layout:O,compute:{module:U,entryPoint:"unscramble"}}),I=e.createComputePipeline({label:`Scramble pipeline N=${r}`,layout:E,compute:{module:B,entryPoint:"scramble"}});return{subRowFFT:z,twiddle:j,columnFFT:X,unscramble:W,scramble:I,simpleFFT:N,transpose:m,bindGroupLayouts:{subRowFFT:F,twiddle:P,columnFFT:h,unscramble:G,scramble:v,simpleFFT:T,transpose:a},N:r,R:l,C:s,isLarge:p}}function re(e){const{device:r,pipelines:t,input:p,output:u,temp:i,N:a,forward:b,splitNormalization:m}=e,{R:l,C:s,isLarge:d}=t,n=r.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});if(r.queue.writeBuffer(n,0,new Uint32Array([a])),!d){oe(r,t,p,u,i,a,b,m,n);return}te(r,t,p,u,i,a,l,s,b,m,n)}function oe(e,r,t,p,u,i,a,b,m){const l=e.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(l,0,new Uint32Array([i,i,a?1:0,b?1:0]));const s=e.createCommandEncoder({label:"Simple 2D FFT"});{const d=e.createBindGroup({layout:r.bindGroupLayouts.simpleFFT,entries:[{binding:0,resource:{buffer:t}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:l}}]}),n=s.beginComputePass({label:"Horizontal FFT"});n.setPipeline(r.simpleFFT),n.setBindGroup(0,d),n.dispatchWorkgroups(i,1,1),n.end()}{const d=e.createBindGroup({layout:r.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:u[1]}},{binding:2,resource:{buffer:m}}]}),n=s.beginComputePass({label:"Transpose 1"});n.setPipeline(r.transpose),n.setBindGroup(0,d),n.dispatchWorkgroups(Math.ceil(i/16),Math.ceil(i/16),1),n.end()}{const d=e.createBindGroup({layout:r.bindGroupLayouts.simpleFFT,entries:[{binding:0,resource:{buffer:u[1]}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:l}}]}),n=s.beginComputePass({label:"Vertical FFT"});n.setPipeline(r.simpleFFT),n.setBindGroup(0,d),n.dispatchWorkgroups(i,1,1),n.end()}{const d=e.createBindGroup({layout:r.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:p}},{binding:2,resource:{buffer:m}}]}),n=s.beginComputePass({label:"Transpose 2"});n.setPipeline(r.transpose),n.setBindGroup(0,d),n.dispatchWorkgroups(Math.ceil(i/16),Math.ceil(i/16),1),n.end()}e.queue.submit([s.finish()])}function te(e,r,t,p,u,i,a,b,m,l,s){const d=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(d,0,new Uint32Array([b,a,i,i*a,m?1:0,l?1:0]));const n=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,new Uint32Array([b,a,i,i,m?1:0]));const _=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(_,0,new Uint32Array([b,a,i,i,m?1:0,l?1:0]));const w=e.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(w,0,new Uint32Array([b,a,i,i]));const g=e.createCommandEncoder({label:"Hierarchical 2D FFT"});{const f=e.createBindGroup({layout:r.bindGroupLayouts.columnFFT,entries:[{binding:0,resource:{buffer:t}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:_}}]}),o=g.beginComputePass({label:"H Column FFT"});o.setPipeline(r.columnFFT),o.setBindGroup(0,f),a<=8?o.dispatchWorkgroups(Math.ceil(i*b/256),1,1):o.dispatchWorkgroups(i*b,1,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.twiddle,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:u[1]}},{binding:2,resource:{buffer:n}}]}),o=g.beginComputePass({label:"H Twiddle"});o.setPipeline(r.twiddle),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(b/16),Math.ceil(i*a/16),1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.subRowFFT,entries:[{binding:0,resource:{buffer:u[1]}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:d}}]}),o=g.beginComputePass({label:"H Sub-row FFT"});o.setPipeline(r.subRowFFT),o.setBindGroup(0,f),o.dispatchWorkgroups(i*a,1,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.unscramble,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:u[1]}},{binding:2,resource:{buffer:w}}]}),o=g.beginComputePass({label:"H Unscramble"});o.setPipeline(r.unscramble),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(i/256),i,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:u[1]}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:s}}]}),o=g.beginComputePass({label:"Transpose 1"});o.setPipeline(r.transpose),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(i/16),Math.ceil(i/16),1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.columnFFT,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:u[1]}},{binding:2,resource:{buffer:_}}]}),o=g.beginComputePass({label:"V Column FFT"});o.setPipeline(r.columnFFT),o.setBindGroup(0,f),a<=8?o.dispatchWorkgroups(Math.ceil(i*b/256),1,1):o.dispatchWorkgroups(i*b,1,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.twiddle,entries:[{binding:0,resource:{buffer:u[1]}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:n}}]}),o=g.beginComputePass({label:"V Twiddle"});o.setPipeline(r.twiddle),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(b/16),Math.ceil(i*a/16),1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.subRowFFT,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:u[1]}},{binding:2,resource:{buffer:d}}]}),o=g.beginComputePass({label:"V Sub-row FFT"});o.setPipeline(r.subRowFFT),o.setBindGroup(0,f),o.dispatchWorkgroups(i*a,1,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.unscramble,entries:[{binding:0,resource:{buffer:u[1]}},{binding:1,resource:{buffer:u[0]}},{binding:2,resource:{buffer:w}}]}),o=g.beginComputePass({label:"V Unscramble"});o.setPipeline(r.unscramble),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(i/256),i,1),o.end()}{const f=e.createBindGroup({layout:r.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:u[0]}},{binding:1,resource:{buffer:p}},{binding:2,resource:{buffer:s}}]}),o=g.beginComputePass({label:"Transpose 2"});o.setPipeline(r.transpose),o.setBindGroup(0,f),o.dispatchWorkgroups(Math.ceil(i/16),Math.ceil(i/16),1),o.end()}e.queue.submit([g.finish()])}function ae(e,r){if(r<2||(r&r-1)!==0)throw new Error(`N must be a power of 2, got ${r}`);const t=e.limits.maxComputeWorkgroupSizeX;if(r>t){const g=ee(e,r);return{fftHorizontal:null,fftVertical:null,transpose:g.transpose,bindGroupLayouts:{fft:null,transpose:g.bindGroupLayouts.transpose},N:r,largePipelines:g,isLarge:!0}}const u=y(r),i=x(),a=e.createShaderModule({label:`FFT Cooley-Tukey shader N=${r}`,code:u}),b=e.createShaderModule({label:"Transpose shader",code:i}),m=e.createBindGroupLayout({label:"FFT bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),l=e.createBindGroupLayout({label:"Transpose bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),s=e.createPipelineLayout({label:"FFT pipeline layout",bindGroupLayouts:[m]}),d=e.createPipelineLayout({label:"Transpose pipeline layout",bindGroupLayouts:[l]}),n=e.createComputePipeline({label:`FFT horizontal pipeline N=${r}`,layout:s,compute:{module:a,entryPoint:"fft_horizontal"}}),_=e.createComputePipeline({label:`FFT vertical pipeline N=${r}`,layout:s,compute:{module:a,entryPoint:"fft_vertical"}}),w=e.createComputePipeline({label:"Transpose pipeline",layout:d,compute:{module:b,entryPoint:"transpose"}});return{fftHorizontal:n,fftVertical:_,transpose:w,bindGroupLayouts:{fft:m,transpose:l},N:r,largePipelines:null,isLarge:!1}}function ue(e){const{device:r,pipelines:t,input:p,output:u,temp:i,N:a,forward:b,splitNormalization:m}=e;if(a!==t.N)throw new Error(`N=${a} doesn't match pipeline N=${t.N}`);if(t.isLarge&&t.largePipelines){re({device:r,pipelines:t.largePipelines,input:p,output:u,temp:i,N:a,forward:b,splitNormalization:m});return}if(!t.fftHorizontal||!t.fftVertical||!t.bindGroupLayouts.fft)throw new Error("Simple FFT pipelines not available");const l=r.createBuffer({label:"FFT params uniform",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),s=new Uint32Array([a,a,b?1:0,m?1:0]);r.queue.writeBuffer(l,0,s);const d=r.createBuffer({label:"Transpose params uniform",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),n=new Uint32Array([a]);r.queue.writeBuffer(d,0,n);const _=r.createBindGroup({label:"FFT horizontal bind group",layout:t.bindGroupLayouts.fft,entries:[{binding:0,resource:{buffer:p}},{binding:1,resource:{buffer:i[0]}},{binding:2,resource:{buffer:l}}]}),w=r.createBindGroup({label:"Transpose 1 bind group",layout:t.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:i[0]}},{binding:1,resource:{buffer:i[1]}},{binding:2,resource:{buffer:d}}]}),g=r.createBindGroup({label:"FFT vertical bind group",layout:t.bindGroupLayouts.fft,entries:[{binding:0,resource:{buffer:i[1]}},{binding:1,resource:{buffer:i[0]}},{binding:2,resource:{buffer:l}}]}),f=r.createBindGroup({label:"Transpose 2 bind group",layout:t.bindGroupLayouts.transpose,entries:[{binding:0,resource:{buffer:i[0]}},{binding:1,resource:{buffer:u}},{binding:2,resource:{buffer:d}}]}),o=r.createCommandEncoder({label:"FFT 2D command encoder"});{const c=o.beginComputePass({label:"FFT horizontal pass"});c.setPipeline(t.fftHorizontal),c.setBindGroup(0,_),c.dispatchWorkgroups(a,1,1),c.end()}{const c=o.beginComputePass({label:"Transpose 1 pass"});c.setPipeline(t.transpose),c.setBindGroup(0,w),c.dispatchWorkgroups(Math.ceil(a/16),Math.ceil(a/16),1),c.end()}{const c=o.beginComputePass({label:"FFT vertical pass"});c.setPipeline(t.fftVertical),c.setBindGroup(0,g),c.dispatchWorkgroups(a,1,1),c.end()}{const c=o.beginComputePass({label:"Transpose 2 pass"});c.setPipeline(t.transpose),c.setBindGroup(0,f),c.dispatchWorkgroups(Math.ceil(a/16),Math.ceil(a/16),1),c.end()}r.queue.submit([o.finish()])}export{ae as createFFTPipelines,ue as executeFFT2D};
