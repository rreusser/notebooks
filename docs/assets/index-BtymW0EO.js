import{_ as L}from"./index-DLwE0_Ng.js";import"./comments-I77vOiCB.js";import{d as s}from"./define-D1bHXsD4.js";s({root:document.getElementById("cell-713"),expanded:[],variables:[]},{id:713,body:(e,t)=>e`The easiest way to think of this is as a <a href="https://en.wikipedia.org/wiki/Pendulum_(mechanics)#Simple_gravity_pendulum">simple gravity pendulum</a> with a rigid, massless bar, and which starts at the unstable equilibrium directly above the pivot before being slightly disturbed and falling. Then our goal is to find the point at which it reaches the maximum horizontal velocity on its way down.
...
But let's disregard this advice and start off our brute force solution by considering our pendulum. The force diagram below illustrates the problem setup. Parameter ${t`k`} parameterizes the kinetic energy of the pendulum, from rest (${t`k = 0`}) to a pendulum with exactly enough energy to start at the bottom and come to rest at the top (${t`k = 1`}).`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-671"),expanded:[],variables:[]},{id:671,body:function(e,t,n,r,a,c,l,d,w){const p=e`The physical setup for a simple gravity pendulum with kinetic energy parameter ${t`k = ${n}`}.`,x=1e3,y=1,m=9.98;function k(h){return 2*Math.asin(n*r(h*Math.sqrt(m/y),n*n))}const $=Math.min(a,640),o=80,u=m/9.81,v=300,f=c.create("svg").attr("width",$).attr("height",v+o).attr("style","border:1px solid #eee;cursor:move"),b=f.append("g").attr("transform",`translate(${$/2},${v/2})`);b.append("line").attr("y2",50).attr("stroke","#555").attr("stroke-dasharray","3,3");const M="#25e",K=b.append("path").attr("fill","#555");b.append("circle").attr("r",v/2*y*.9).style("stroke","#aaa").style("fill","none").style("stroke-dasharray","4,4");const V=b.append("path").attr("fill","#555"),C=b.append("text").text("θ").attr("dx",2).attr("dy",15).style("font-family","KaTeX_Math"),I=[k].map(h=>{const i={theta:h,line:b.append("line").attr("y2",v/2*y*.9).style("stroke",h===k?"#444":"#ccc").style("stroke-width",3).style("stroke-linecap","round"),mass:b.append("g").attr("transform",`translate(0,${v/2*y*.9})`)};return i.radArrowhead=i.mass.append("path").attr("fill",M),i.radialForce=i.mass.append("line").attr("x2",0).attr("y2",o*u).attr("stroke",M).attr("stroke-width",2),i.force=i.mass.append("line").attr("x2",0).attr("y2",o*u-5).attr("stroke","#e25").attr("stroke-width",2),i.gArrowhead=i.mass.append("path").attr("fill","#e25").attr("d",l(0,0,0,o*u)),i.tanArrowhead=i.mass.append("path").attr("fill",M),i.torqueForce=i.mass.append("line").attr("x2",0).attr("y2",o*u).attr("stroke",M).attr("stroke-width",2),i.circle=i.mass.append("circle").attr("r",10).style("stroke","white").style("stroke-width",1).style("fill",h===k?"#e25":"#ccc"),i.text=i.mass.append("text").text("-mg").style("font-family","KaTeX_Math").attr("dy",10).style("text-anchor","middle").attr("y",o*u),i.lText=b.append("text").text("l").style("font-family","KaTeX_Math").style("visibility","hidden"),i.sinText=i.mass.append("text").style("font-family","KaTeX_Math").attr("dx",3).attr("dy",-3),i.sinText.style("visibility","hidden"),i.sinText.append("tspan").text("-mg "),i.sinText.append("tspan").style("font-family","KaTeX_Main").text("sin"),i.sinText.append("tspan").text(" θ"),i});f.append("g");const J=k;function E(h,i=null){const F=h/x;I.forEach(_=>{const z=i===null?J(F):i,[T,g]=[Math.cos(z),Math.sin(z)],j=v/2*y*.9*g,Y=v/2*(y*.9*T);_.line.attr("x2",j).attr("y2",Y),_.mass.attr("transform",`translate(${j},${Y})`),_.lText.attr("x",j/2).attr("y",Y/2).attr("dx",10*-T).attr("dy",15*g).attr("text-anchor","middle").attr("alignment-baseline","middle");const S=Math.sign(-g*T);_.radialForce.attr("x1",S*g*g*u*5).attr("y1",S*T*g*u*5+o*u).attr("x2",-o*g*T*u).attr("y2",o*g*g*u),_.torqueForce.attr("x2",-75*T*g*u).attr("y2",(o-5)*g*g*u),_.tanArrowhead.attr("d",l(0,0,-o*T*g*u,o*g*g*u)),_.radArrowhead.attr("d",l(-o*T*g*u,o*g*g*u,0,o*u));const H=g;_.sinText.attr("x",-o*H*T*u).attr("y",o*H*g*u).attr("dx",S>0?3:-3).attr("text-anchor",S>0?"start":"end");const R=Math.cos(Math.max(z,0)),X=Math.sin(Math.max(z,0));V.attr("d",l(X*15.25-R,R*15.25+X,X*15.5,R*15.5,{length:8,width:7,inset:1.5}));const U=Math.max(z,0)*.5;C.attr("x",Math.sin(U)*15.5).attr("y",Math.cos(U)*15.5)}),K.attr("d",c.arc().innerRadius(15).outerRadius(16).startAngle(Math.PI).endAngle(Math.PI-(i===null?J(F):i))),i===null&&(q=requestAnimationFrame(E))}function B(h){const i=f.node().getBoundingClientRect(),F=h.clientX-i.left-$/2,_=h.clientY-i.top-v/2;E(null,Math.atan2(F,_))}function D(){f.node().addEventListener("mousemove",B),I[0].sinText.style("visibility","visible"),I[0].lText.style("visibility","visible"),cancelAnimationFrame(q),q=null}function O(){I[0].sinText.style("visibility","hidden"),I[0].lText.style("visibility","hidden"),f.node().removeEventListener("mousemove",B),q===null&&(q=requestAnimationFrame(E))}function P(h){D(),h.preventDefault(),h.stopPropagation(),B({clientX:h.touches[0].clientX,clientY:h.touches[0].clientY})}function W(h){h.preventDefault(),h.stopPropagation(),B({clientX:h.touches[0].clientX,clientY:h.touches[0].clientY})}function N(h){h.touches.length||O()}f.node().addEventListener("mouseover",D),f.node().addEventListener("mouseout",O),f.node().addEventListener("touchstart",P),f.node().addEventListener("touchmove",W),f.node().addEventListener("touchend",N);let A;setTimeout(()=>{A=new d(function([h]){h.isIntersecting?q||(q=requestAnimationFrame(E)):(cancelAnimationFrame(q),q=null)}),A.observe(f.node())},1),w.then(()=>{cancelAnimationFrame(q),A&&A.disconnect()});let q=requestAnimationFrame(E);return e`<figure>
    ${f.node()}
...
Recall that ${t`\mathrm{sech}(u) \equiv 1/\mathrm{cosh}(u).`} So in this sense they sort of interpolate between the [trigonometric](https://en.wikipedia.org/wiki/Trigonometric_functions) and [hyperbolic](https://en.wikipedia.org/wiki/Hyperbolic_functions) functions. Very cool. See [Jacobi Elliptic Functions in the Complex Plane](https://observablehq.com/@rreusser/jacobi-elliptic-functions-in-the-complex-plane) for an even lovelier view of how this generalization works.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-769"),expanded:[],variables:[]},{id:769,body:(e,t,n,r,a,c,l,d,w,p,x)=>{let y;e<1?y=t(e):e===1?y=10:y=t(1/e)/Math.sqrt(e);const m=501,k=[...Array(m).keys()].map(o=>(o/(m-1)*5-.5)*y),$=k.map(o=>{const u=o/y;let v,f,b;v=n(o,e),f=r(o,e),b=a(o,e);const M=c(o,e),K=f*f+(1-e)*v*v-b*b;return{am:M,uK:u,u:o,sn:v,cn:f,dn:b,am:M,checksum:K}});return l(d.html`<figure style="max-width:100%">${w.plot({width:Math.min(640,p),height:300,grid:!0,x:{label:"u / K →",ticks:4},y:{},marks:[w.ruleY([0]),w.line($,{x:"uK",y:"sn",stroke:"#c39"}),w.line($,{x:"uK",y:"cn",stroke:"#9c3"}),w.line($,{x:"uK",y:"dn",stroke:"#39c"})].filter(o=>o)})}<figcaption>
...
Let's plot it!`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-5"),expanded:[],variables:[]},{id:5,body:function(t){return t`g = ${9.81} m/s²`},inputs:["fmt"],outputs:void 0,output:"viewof$g",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});s({root:document.getElementById("cell-4"),expanded:[],variables:[]},{id:4,body:function(t){return t`l = ${100*(12*.0254)} m`},inputs:["fmt"],outputs:void 0,output:"viewof$l",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});s({root:document.getElementById("cell-48"),expanded:[],variables:[]},{id:48,body:function(t,n,r,a,c,l,d,w){const p=t*t,x=p===1?2:n(p),y=Math.sqrt(r/a);return[...c(0,4*x,401)].map(m=>({u:m,t:m*Math.sqrt(a/r),uK:m/x,theta:2*Math.asin(t*l(m,p)),dtheta:2*t*d(m,p),x:2*t*a*l(m,p)*w(m,p),xdot:2*t*a*d(m,p)*(2*w(m,p)**2-1)*y,xddot:-2*t*a*l(m,p)*w(m,p)*(6*w(m,p)**2+4*p-5)*y**2}))},inputs:["k","ellipk","g","l","linspace","sn","cn","dn"],outputs:void 0,output:"trajectory",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-41"),expanded:[],variables:[]},{id:41,body:function(e,t,n,r,a){return e.html`<figure>${t.plot({width:Math.min(n,640),height:200,grid:!0,x:{label:"t →"},y:{label:"θ(t) ↑",domain:[-Math.PI,Math.PI]},marks:[t.ruleY([0]),t.ruleY([-Math.PI,Math.PI],{strokeDasharray:"4,4"}),t.line(r,{x:"t",y:"theta",stroke:"#c39"})]})}<figcaption>Angle ${a`\theta`} of a pendulum which starts at ${a`\theta(t = 0) = 0`} with an initial velocity.</figcaption></figure>`},inputs:["htl","Plot","width","trajectory","tex"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-32"),expanded:[],variables:[]},{id:32,body:function(e,t,n){return e.bind(e.range([0,.9999999],{label:t`k \;\;(= \sqrt{m})`,step:1e-7}),n)},inputs:["Inputs","tex","viewof$k"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-283"),expanded:[],variables:[]},{id:283,body:(e,t)=>e`Note that as ${t`k`} approaches ${t`1`}, the period diverges to infinity. This just reflects the fact that if the pendulum (asymptotically) makes it all the way to the top, ${t`\theta = \pm \pi`}, it takes forever to get there, equivalent to an infinitely long period.
...
Let's plot in terms of scaled time ${t`u`} to see if this looks plausible.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-336"),expanded:[],variables:[]},{id:336,body:function(){return Math.log(Math.sqrt(6)+Math.sqrt(5))},inputs:[],outputs:void 0,output:"u_max",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-299"),expanded:[],variables:[]},{id:299,body:function(t,n,r,a){return[...t(0,4,201)].map(c=>({u:c,t:c*Math.sqrt(n/r),uK:c,xdot:2*a*n/Math.cosh(c)*(2/Math.cosh(c)**2-1)}))},inputs:["linspace","l","g","k"],outputs:void 0,output:"upswing",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-303"),expanded:[],variables:[]},{id:303,body:function(e,t,n,r,a,c,l,d){const w=2*e*t/Math.cosh(n)*(2/Math.cosh(n)**2-1);return r.html`<figure>${a.plot({width:Math.min(c,640),height:200,grid:!0,x:{label:"u →"},y:{label:"dx(u)/dt ↑"},marks:[a.ruleY([0]),a.line(l,{x:"uK",y:"xdot",stroke:"#c39"}),a.dot([{x:n,y:w}],{x:"x",y:"y",stroke:"#c39",fill:"#c39"})]})}<figcaption>Horizontal velocity for an upswinging pendulum with ${d`k = 1`}, with a dot representing the extremum at ${d`u = \ln\left(\sqrt{6} + \sqrt{5}\right)`}.</figcaption></figure>`},inputs:["k","l","u_max","htl","Plot","width","upswing","tex"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-330"),expanded:[],variables:[]},{id:330,body:(e,t)=>e`Success! That looks like an extremum in the horizontal velocity! And so we arrive at the endgame. At last, we plug scaled time ${t`u`} into the equation for ${t`\theta(u)`} to compute the angle at which the horizontal velocity is maximized. For ${t`k = 1`}, the equation of motion is
...
This is the horizontal distance from the pivot to the mass when the mass reaches its maximum horizontal velocity. This is also therefore the distance from the gates at which we—er, the _orcs_—should place the pivot of the pole. Substituting some numbers, we get`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-395"),expanded:[],variables:[]},{id:395,body:function(t,n){return t`d_initial = ${n*Math.sqrt(1-4/9)} m`},inputs:["fmt","l"],outputs:void 0,output:"viewof$d_initial",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});s({root:document.getElementById("cell-761"),expanded:[],variables:[]},{id:761,body:async()=>{const[{default:e},{default:t},{default:n}]=await Promise.all([L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/array-linspace/+esm"),[]).then(d=>{if(!("default"in d))throw new SyntaxError("export 'default' not found");return d}),L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/math-base-special-ellipk/+esm"),[]).then(d=>{if(!("default"in d))throw new SyntaxError("export 'default' not found");return d}),L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/math-base-special-ellipj/+esm"),[]).then(d=>{if(!("default"in d))throw new SyntaxError("export 'default' not found");return d})]),{sn:r,cn:a,dn:c,am:l}=n;return{linspace:e,ellipk:t,jacobi:n,sn:r,cn:a,dn:c,am:l}},inputs:[],outputs:["linspace","ellipk","jacobi","sn","cn","dn","am"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-12"),expanded:[],variables:[]},{id:12,body:e=>({fmt:e(".3f")}),inputs:["createFmt"],outputs:["fmt"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-7"),expanded:[],variables:[]},{id:7,body:async(e,t)=>{const{fmt:n,sci:r}=await L(()=>import("https://api.observablehq.com/@rreusser/fmt.js?v=4"),[]).then(a=>{const c={},l=e.module(a.default),d=e.module();if(!l.defines("fmt"))throw new SyntaxError("export 'fmt' not found");if(d.variable(c.fmt=t()).import("fmt",l),!l.defines("sci"))throw new SyntaxError("export 'sci' not found");return d.variable(c.sci=t()).import("sci",l),c});return{createFmt:n,sci:r}},inputs:["__ojs_runtime","__ojs_observer"],outputs:["createFmt","sci"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-676"),expanded:[],variables:[]},{id:676,body:()=>{function e(t,n,r,a,{length:c=10,width:l=8,shift:d=0,inset:w=2}={}){const p=r-t,x=a-n,y=Math.sqrt(p*p+x*x),m=p/y,k=x/y,$=-k,o=m,u=r-c*m,v=a-c*k,f=d*m,b=d*k;return`M${r+f},${a+b}L${u+$*l/2+f},${v+o*l/2+b}L${u+w*m+f},${v+w*k+b}L${u-$*l/2+f},${v-o*l/2+b}Z`}return{arrowhead:e}},inputs:[],outputs:["arrowhead"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});
