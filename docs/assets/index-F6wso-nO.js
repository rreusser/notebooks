import{_ as g,d as p}from"./index-Bvdv0JJ6.js";import"./comments-I77vOiCB.js";(window.location.hostname==="localhost"||window.location.hostname.match(/127\.0\.0\.1/))&&g(async()=>{const{main:e}=await import("./index-Bvdv0JJ6.js").then(t=>t.i);return{main:e}},[]).then(({main:e})=>{window.__observableRuntime=e,console.log("[DebugClient] Runtime module exposed as window.__observableRuntime"),g(()=>import("./debug-client-BJyqFSh-.js"),[])});p({root:document.getElementById("cell-29"),expanded:[],variables:[]},{id:29,body:(e,t,o,n,i,d,l,s,c)=>{const u=e({container:t,width:Math.min(o,640),height:Math.min(640,o),layers:{regl:({current:a,width:r,height:y})=>{const m=devicePixelRatio;return a=a||n(i,{attributes:{depthStencil:!1},pixelRatio:m}),a.style.width=`${r}px`,a.style.height=`${y}px`,a.width=r*m,a.height=y*m,a},plot:({width:a,height:r})=>d.plot({width:a,height:r,aspectRatio:1,marginTop:0,marginRight:5,marginLeft:22,marginBottom:20,style:{backgroundColor:"transparent",maxWidth:"none"},x:{domain:[-3,3],grid:!0,tickSpacing:100},y:{domain:[-2.9*r/a,2.9*r/a],grid:!0,tickSpacing:100}}),svg:({width:a,height:r})=>l.create("svg").attr("width",a).attr("height",r).node()}}),f=u.value;return s(c`<figure>
  ${u}
  <figcaption>Drag points to adjust magnet positions.</figcaption>
</figure>`),{el:u,stack:f}},inputs:["createElementStack","stackEl","width","reglCanvas","createREGL","Plot","d3","display","html"],outputs:["el","stack"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-30"),expanded:[],variables:[]},{id:30,body:(e,t)=>{const o=e(t.range([0,1],{label:"pendulum height, h",value:.5})),n=e(t.range([1e-8,1],{label:"friction",value:.2})),i=e(t.range([1e-6,.01],{transform:Math.log,label:"tolerance",value:3e-4})),d=e(t.range([0,200],{label:"integration steps",value:120,step:1})),l=e(t.range([2,10],{label:"Magnet count",value:3,step:1})),s=e(t.checkbox(["Draw trajectory"],{value:["Draw trajectory","Use steps which exceed tolerance"]}));return{h:o,b:n,tolerance:i,steps:d,N:l,opts:s}},inputs:["view","Inputs"],outputs:["h","b","tolerance","steps","N","opts"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-10"),expanded:[],variables:[]},{id:10,body:(e,t)=>e`For two-dimensional position ${t`\mathbf{x}`}, friction ${t`b`}, and magnets ${t`\mathbf{X}_n`}, the pendulum moves according to the equations`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});p({root:document.getElementById("cell-11"),expanded:[],variables:[]},{id:11,body:(e,t,o)=>e`${t.block`
...
\`\`\``,inputs:["md","steps"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});p({root:document.getElementById("cell-67"),expanded:[],variables:[]},{id:67,body:e=>{const t=Array.from({length:e}).map((i,d)=>d),o=`float quasirandom (int n) {
...
vec3 palette(float t) {
  ...
  ${t.map(i=>`vec2 r${i} = y - p${i};`).join(`
  `)}
  ${t.map(i=>`float w${i} = 1.0 / dot(r${i}, r${i}); w${i} *= w${i};`).join(`
  `)}
  return (
    ${t.map(i=>`w${i} * mix(palette(0.63 + quasirandom(${i})), vec3(0.9), 0.35)`).join(` +
    `)}
  ) / (${t.map(i=>`w${i}`).join(" + ")});
...
${t}
\`\`\``,inputs:["md","glslScheme"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});p({root:document.getElementById("cell-7"),expanded:[],variables:[]},{id:7,body:async(e,t)=>{const[{mat4:o},{default:n},{ode45:i}]=await Promise.all([g(()=>import("https://cdn.jsdelivr.net/npm/gl-matrix/+esm"),[]).then(d=>{if(!("mat4"in d))throw new SyntaxError("export 'mat4' not found");return d}),g(()=>import("https://cdn.jsdelivr.net/npm/regl/+esm"),[]).then(d=>{if(!("default"in d))throw new SyntaxError("export 'default' not found");return d}),g(()=>import("https://api.observablehq.com/@rreusser/integration.js?v=4"),[]).then(d=>{const l={},s=e.module(d.default),c=e.module();if(!s.defines("ode45"))throw new SyntaxError("export 'ode45' not found");return c.variable(l.ode45=t()).import("ode45",s),l})]);return{mat4:o,createREGL:n,ode45:i}},inputs:["__ojs_runtime","__ojs_observer"],outputs:["mat4","createREGL","ode45"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-2"),expanded:[],variables:[]},{id:2,body:async()=>{const[{initializeElementStack:e,createElementStack:t,createAxisConfiguration:o},{reglCanvas:n}]=await Promise.all([g(()=>import("./element-stack--iI8y0aQ.js"),[]).then(i=>{if(!("initializeElementStack"in i))throw new SyntaxError("export 'initializeElementStack' not found");if(!("createElementStack"in i))throw new SyntaxError("export 'createElementStack' not found");if(!("createAxisConfiguration"in i))throw new SyntaxError("export 'createAxisConfiguration' not found");return i}),g(()=>import("./regl-canvas-DbKbmlCP.js"),[]).then(i=>{if(!("reglCanvas"in i))throw new SyntaxError("export 'reglCanvas' not found");return i})]);return{initializeElementStack:e,createElementStack:t,createAxisConfiguration:o,reglCanvas:n}},inputs:[],outputs:["initializeElementStack","createElementStack","createAxisConfiguration","reglCanvas"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-3"),expanded:[],variables:[]},{id:3,body:e=>({stackEl:e()}),inputs:["initializeElementStack"],outputs:["stackEl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-18"),expanded:[],variables:[]},{id:18,body:e=>{const t=e.regl.value,o=e.svg.value;return{regl:t,svg:o,state:{dirty:!1}}},inputs:["stack"],outputs:["regl","svg","state"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-27"),expanded:[],variables:[]},{id:27,body:e=>({magnets:Array.from({length:e}).map((o,n)=>({index:n,x:Math.sin(2*Math.PI*n/e),y:Math.cos(2*Math.PI*n/e)}))}),inputs:["N"],outputs:["magnets"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-24"),expanded:[],variables:[]},{id:24,body:(e,t,o,n,i)=>{function d(s,[c,u,f,a]){let r=0,y=0;for(let m=0;m<e.length;m++){const v=e[m].x-c,b=e[m].y-u,h=v*v+b*b+t*t,x=1/(h*h*Math.sqrt(h));r+=v*x,y+=b*x}s[0]=f,s[1]=a,s[2]=r-o*f-c,s[3]=y-o*a-u}function l([s,c]){if(!~n.indexOf("Draw trajectory")||isNaN(s))return[];const u={y:[s,c,0,0],t:0},f=[{x:u.y[0],y:u.y[1]}];for(let a=0;a<2e3&&!u.limitReached;a++)i(u,d,{tLimit:50,tolerance:2e-6}),f.push({x:u.y[0],y:u.y[1]});return f}return{deriv:d,computeTrajectory:l}},inputs:["magnets","h","b","opts","ode45"],outputs:["deriv","computeTrajectory"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-26"),expanded:[],variables:[]},{id:26,body:(e,t,o,n,i)=>{const d=e.plot.scale("x"),l=e.plot.scale("y"),s=t.select(e.svg).style("cursor","crosshair");t.selectAll("circle").remove(),s.on("mousemove",a=>{u(o([d.invert(a.offsetX),l.invert(a.offsetY)]))});const c=t.line().x(({x:a})=>d.apply(a)).y(({y:a})=>l.apply(a));function u(a){s.selectAll(".trajectorybg").data([a||[]]).join(r=>r.append("path").style("fill","none").style("stroke-width",5).style("stroke","rgba(255,255,255,0.6)").attr("class","trajectorybg").attr("d",c),r=>r.attr("d",c)),s.selectAll(".trajectory").data([a||[]]).join(r=>r.append("path").style("fill","none").style("stroke-width",2).style("stroke","blue").attr("class","trajectory").attr("d",c),r=>r.attr("d",c))}function f(a){a.attr("r",5).attr("cx",({x:r})=>d.apply(r)).attr("cy",({y:r})=>l.apply(r))}return u([]),s.selectAll("circle").data(n).join(a=>a.append("circle").style("fill","black").style("stroke","white").style("stroke-width",2).style("cursor","move").call(f).call(t.drag().on("drag",r=>{let{sourceEvent:{offsetX:y,offsetY:m,touches:v},subject:{index:b}}=r;if(v?.length){const{x:h,y:x}=s.node().getBoundingClientRect();y=v[0].clientX-h,m=v[0].clientY-x}n[b].x=d.invert(y),n[b].y=l.invert(m),s.selectAll("circle").call(f),i.dirty=!0})),a=>a.call(f)),{xScale:d,yScale:l,svg:s,makeline:c,updateTrajectory:u,updatePositions:f}},inputs:["stack","d3","computeTrajectory","magnets","state"],outputs:["xScale","yScale","svg","makeline","updateTrajectory","updatePositions"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-20"),expanded:[],variables:[]},{id:20,body:(e,t,o,n,i,d,l,s,c,u,f)=>{e.dirty=!0;let a=t.frame(({time:r})=>{if(e.dirty)try{o(n.plot.scale("x"),n.plot.scale("y"),()=>{t.clear({color:[1,0,0,1]}),i({h:d,b:l,magnets:s,tolerance:c,discard:!u.includes("Use steps which exceed tolerance")})}),e.dirty=!1}catch(y){console.error(y),a&&a.cancel(),a=null}});return f.then(()=>{a&&a.cancel(),a=null}),{loop:a}},inputs:["state","regl","configureAxes","stack","drawField","h","b","magnets","tolerance","opts","invalidation"],outputs:["loop"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-22"),expanded:[],variables:[]},{id:22,body:(e,t,o)=>({configureAxes:e(t,o)}),inputs:["createAxisConfiguration","mat4","regl"],outputs:["configureAxes"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-21"),expanded:[],variables:[]},{id:21,body:(e,t,o,n,i,d)=>{const l={};for(let c=0;c<e;c++)l[`p${c}`]=(u,{magnets:f})=>[f[c].x,f[c].y];const s=t({vert:`
    ...
    }`,attributes:{uv:[-4,-4,4,-4,0,4]},uniforms:{h2:(c,{h:u})=>u*u,b:t.prop("b"),tol2:(c,{tolerance:u})=>u*u,discardFails:t.prop("discard"),...l},count:3,depth:{enable:!1}});return{magnetUniforms:l,drawField:s}},inputs:["N","regl","glslDeriv","glslPalette","glslScheme","steps"],outputs:["magnetUniforms","drawField"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-59"),expanded:[],variables:[]},{id:59,body:()=>{function e(o){return o<=.04045?o/12.92:Math.pow((o+.055)/1.055,2.4)}function t(o){o=o.replace(/^#/,""),o.length===3&&(o=o.split("").map(l=>l+l).join(""));const n=e(parseInt(o.slice(0,2),16)/255),i=e(parseInt(o.slice(2,4),16)/255),d=e(parseInt(o.slice(4,6),16)/255);return[n,i,d]}return{srgbToLinear:e,hexToLinearRgb:t}},inputs:[],outputs:["srgbToLinear","hexToLinearRgb"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});p({root:document.getElementById("cell-60"),expanded:[],variables:[]},{id:60,body:(e,t)=>({colorScheme:e.schemeCategory10.map(t).map(([n,i,d])=>`vec3(${n},${i},${d})`)}),inputs:["d3","hexToLinearRgb"],outputs:["colorScheme"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});
