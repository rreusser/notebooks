import"./index-DLwE0_Ng.js";import{d}from"./define-D1bHXsD4.js";d({root:document.getElementById("cell-301"),expanded:[],variables:[]},{id:301,body:function(e){return e`# Computing π with the Bailey-Borwein-Plouffe Formula`},inputs:["md"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1220"),expanded:[],variables:[]},{id:1220,body:e=>e.block`\pi =\sum _{k=0}^{\infty }\left[{\frac {1}{16^{k}}}\left({\frac {4}{8k+1}}-{\frac {2}{8k+4}}-{\frac {1}{8k+5}}-{\frac {1}{8k+6}}\right)\right].`,inputs:["tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1771"),expanded:[],variables:[]},{id:1771,body:(e,t)=>e`The [Baily-Borwein-Plouffe](https://en.wikipedia.org/wiki/Bailey%E2%80%93Borwein%E2%80%93Plouffe_formula) (BBP) formula is a remarkable formula for computing the hexadecimal digits of ${t`\pi`}, starting at the ${t`n^{th}`} digit, *without first computing preceeding digits*!`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1770"),expanded:[],variables:[]},{id:1770,body:(e,t)=>e`That such a formula could exist is a bit shocking—though the initial shock is tempered by the realization that it does, of course, take longer as you start at later digits (${t`O(n \log n)`} as a function of the starting digit, to be precise). Additionally, the hexadecimal digits cannot be converted to decimal without first computing all of the leading digits. What it does enable though, is to compute digits deep into ${t`\pi`} with hardly any memory consumption and nothing more than a basic double precision data type.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1193"),expanded:[],variables:[]},{id:1193,body:function*(t,i,a){if(!this){yield t`Click to compute π starting at the millionth hexadecimal digit.`;return}yield t`Computing…`;const n=performance.now(),u=10,f=a(1e6,u),c=performance.now();yield t`<div>
    Hexadecimal digits of π starting at the millionth (computed in ${((c-n)/1e3).toFixed(2)} seconds):<br><code style="color:rgb(32, 165, 186)">${f.toString(16).padStart(u,"0")}</code>
  </div>`},inputs:["html","recompute","computePi"],outputs:void 0,output:"viewof$dummy",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});d({root:document.getElementById("cell-1242"),expanded:[],variables:[]},{id:1242,body:(e,t)=>({recompute:e(t.button("Compute"))}),inputs:["view","Inputs"],outputs:["recompute"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1774"),expanded:[],variables:[]},{id:1774,body:(e,t)=>e`The table below shows hexadecimal digits of ${t`\pi`}. Each line represents an independent run of the algorithm starting at a slightly different digit. Green digits are correctly computed digits, while red represents incorrect digits. Due to our termination criteria, we usually get a couple fewer digits than requested.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-805"),expanded:[],variables:[]},{id:805,body:(e,t)=>({method:e(t.radio(["Floating point","BigInt"],{label:"Data type",value:"Floating point"}))}),inputs:["view","Inputs"],outputs:["method"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-333"),expanded:[],variables:[]},{id:333,body:(e,t,i)=>({startingDigit:e(t.range([0,i.digits.length-128],{value:0,label:"Starting digit",step:1}))}),inputs:["view","Inputs","reference"],outputs:["startingDigit"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-437"),expanded:[],variables:[]},{id:437,body:(e,t,i)=>({digits:e(t.range([2,i==="Floating point"?14:128],{label:"Digits to compute",value:i==="Floating point"?14:128,step:1}))}),inputs:["view","Inputs","method"],outputs:["digits"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-478"),expanded:[],variables:[]},{id:478,body:function*(t,i,a,n,u,f,c,b){const s=Math.floor(t/954*128),o=i.digits.slice(a,a+s);function g(r,l,y){const p=document.createElement("span"),w=document.createElement("span");w.textContent=a===0&&y>0?o[0]+"."+o.slice(1,y):o.slice(0,y),p.appendChild(w),p.style.color="#ccc";for(let m=0;m<o.length-y;m++){const h=document.createElement("span");h.textContent=l[m],p.appendChild(h);const B=r[m]===l[m]?"rgb(32, 165, 186)":"#c12";if(h.style.color=B,h.style.fontWeight=900,a===0&&y===0&&m===0){const k=document.createElement("span");k.textContent=".",k.style.color=B,p.appendChild(k)}}const v=document.createElement("span");return v.textContent=o.slice(y+n,o.length),p.appendChild(v),p.style.color="#bbb",p}const x=[],I=a===0?o[0]+"."+o.slice(1):o;for(let r=a;r<a+o.length;r+=4){const l=document.createElement("code");l.style.fontSize="inherit",l.style.color="#ccc",l.textContent=I,x.push(l)}const E=x.map(r=>u`<code style="font-size:inherit;">${r}</code><br>`),$=u`
    <pre style="font-size:${11}px;background:white">
${E}</pre>
  `,_=f==="Floating point"?c:b;for(let r=0,l=a;l<a+o.length;r++,l+=4){const y=performance.now(),p=_(l,n),w=performance.now(),v=p.toString(16).padStart(n,"0"),m=g(i.digits.slice(l,l+n),v,l-a),h=document.createElement("code");h.style.fontSize="inherit",h.textContent=` (${(w-y).toFixed(1)}ms)`,m.appendChild(h),x[r].replaceWith(m),yield $}},inputs:["width","reference","startingDigit","digits","html","method","computePi","computePiBigInt"],outputs:void 0,output:"table",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1816"),expanded:[],variables:[]},{id:1816,body:function(){return{digits:`
