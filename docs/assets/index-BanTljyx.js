...
Finally, I've used D3 for the linear scales and zoom interaction. This notebook uses the same zooming and Plot-based axis rendering approach as other notebooks in this collection.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});x({root:document.getElementById("cell-100"),expanded:[],variables:[]},{id:100,body:(i,e,t,s,o,c,n)=>{const l=i`<figure>
  ...
  vec3 linearToSRGB(vec3 rgb) {
    ...
    void main () {
      ...
      }`,attributes:{xy:i.prop("pointsBuffer")},blend:{enable:!0,func:{srcRGB:"src alpha",dstRGB:1,srcAlpha:1,dstAlpha:1},equation:{rgb:"reverse subtract",alpha:"add"}},uniforms:{view:i.prop("view"),invertedPointColor:i.prop("invertedPointColor"),minimumPointDeviceSize:i.prop("minimumPointDeviceSize"),opacity:i.prop("opacity"),pointSize:i.prop("pointSize")},primitive:"points",count:i.prop("N"),depth:{enable:!1},scissor:{enable:!0,box:i.prop("scissor")},viewport:i.prop("viewport")})}let _=i.buffer(e(t,s,{x:o,y:c})),z=i.framebuffer({width:Math.floor(n.width*l),height:Math.floor(n.height*l),colorType:h}),T=B(v),C=t,D=s,$=h,G=l,L=v;const W=i.frame(()=>{if((t!==C||s!==D)&&(_.destroy(),_=i.buffer(e(t,s,{x:o,y:c})),C=t,D=s,y.dirty=!0),(h!==$||l!==G)&&(z.destroy(),z=i.framebuffer({width:Math.floor(n.width*l),height:Math.floor(n.height*l),colorType:h}),$=h,G=l,y.dirty=!0),v!==L&&(T=B(v),L=v,y.dirty=!0),(a||r||d||p||f||g)&&(y.dirty=!0),!y.dirty)return;const E=Math.floor(n.width*l),F=Math.floor(n.height*l);(z.width!==E||z.height!==F)&&z.resize(E,F);const I={x:Math.min(u.xRange[0],u.xRange[1])*l,y:F-Math.max(u.yRange[0],u.yRange[1])*l,width:Math.abs(u.xRange[1]-u.xRange[0])*l,height:Math.abs(u.yRange[0]-u.yRange[1])*l},H={view:u.view,viewportWidth:I.width,viewportHeight:I.height,pixelRatio:l},Y={N:s,pointYAxisSize:a,pointScreenSize:[d,p],minimumPointDeviceSize:f,rho:r,circularPoints:v,initialAxisDimensions:m},X=w(g),O=b(X);z.use(()=>{i.clear({color:[1,1,1,1]}),T({view:u.view,pointsBuffer:_,N:s,invertedPointColor:[1-O[0],1-O[1],1-O[2]],minimumPointDeviceSize:f,opacity:S(H,Y),pointSize:R(H,Y),viewport:I,scissor:I})}),k({src:z}),y.dirty=!1});return M.then(()=>{W.cancel(),_.destroy(),z.destroy()}),{GLSL_SRGB_GAMMA:P,copyToScreen:k,createDrawPoints:B,pointsBuffer:_,fbo:z,drawPoints:T,currentPlotData:C,currentN:D,currentColorType:$,currentPixelRatio:G,currentCircularPoints:L,loop:W}},inputs:["regl","generatePoints","plotData","N","initialXDomain","initialYDomain","stack","pixelRatio","colorType","circularPoints","render","pointYAxisSize","rho","pointScreenSizeMin","pointScreenSizeMax","minimumPointDeviceSize","pointColor","axes","initialAxisDimensions","hexToRgb","sRGBToLinear","pointOpacity","pointSizeDevicePixels","invalidation"],outputs:["GLSL_SRGB_GAMMA","copyToScreen","createDrawPoints","pointsBuffer","fbo","drawPoints","currentPlotData","currentN","currentColorType","currentPixelRatio","currentCircularPoints","loop"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});x({root:document.getElementById("cell-400"),expanded:[],variables:[]},{id:400,body:async()=>{const{collapseCodeBlocks:i}=await A(()=>import("./collapsible-code-B4YhJ-0K.js"),[]).then(e=>{if(!("collapseCodeBlocks"in e))throw new SyntaxError("export 'collapseCodeBlocks' not found");return e});return i({maxHeight:1e3}),{collapseCodeBlocks:i}},inputs:[],outputs:["collapseCodeBlocks"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});
