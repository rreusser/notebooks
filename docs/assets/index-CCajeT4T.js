...
But let's disregard this advice and start off our brute force solution by considering our pendulum. The force diagram below illustrates the problem setup. Parameter ${t`k`} parameterizes the kinetic energy of the pendulum, from rest (${t`k = 0`}) to a pendulum with exactly enough energy to start at the bottom and come to rest at the top (${t`k = 1`}).`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-671"),expanded:[],variables:[]},{id:671,body:function(e,t,n,r,o,u,l,c,b){const f=e`The physical setup for a simple gravity pendulum with kinetic energy parameter ${t`k = ${n}`}.`,x=1e3,y=1,m=9.98;function k(h){return 2*Math.asin(n*r(h*Math.sqrt(m/y),n*n))}const $=Math.min(o,640),a=80,d=m/9.81,v=300,p=u.create("svg").attr("width",$).attr("height",v+a).attr("style","border:1px solid #eee;cursor:move"),w=p.append("g").attr("transform",`translate(${$/2},${v/2})`);w.append("line").attr("y2",50).attr("stroke","#555").attr("stroke-dasharray","3,3");const M="#25e",K=w.append("path").attr("fill","#555");w.append("circle").attr("r",v/2*y*.9).style("stroke","#aaa").style("fill","none").style("stroke-dasharray","4,4");const V=w.append("path").attr("fill","#555"),C=w.append("text").text("θ").attr("dx",2).attr("dy",15).style("font-family","KaTeX_Math"),I=[k].map(h=>{const i={theta:h,line:w.append("line").attr("y2",v/2*y*.9).style("stroke",h===k?"#444":"#ccc").style("stroke-width",3).style("stroke-linecap","round"),mass:w.append("g").attr("transform",`translate(0,${v/2*y*.9})`)};return i.radArrowhead=i.mass.append("path").attr("fill",M),i.radialForce=i.mass.append("line").attr("x2",0).attr("y2",a*d).attr("stroke",M).attr("stroke-width",2),i.force=i.mass.append("line").attr("x2",0).attr("y2",a*d-5).attr("stroke","#e25").attr("stroke-width",2),i.gArrowhead=i.mass.append("path").attr("fill","#e25").attr("d",l(0,0,0,a*d)),i.tanArrowhead=i.mass.append("path").attr("fill",M),i.torqueForce=i.mass.append("line").attr("x2",0).attr("y2",a*d).attr("stroke",M).attr("stroke-width",2),i.circle=i.mass.append("circle").attr("r",10).style("stroke","white").style("stroke-width",1).style("fill",h===k?"#e25":"#ccc"),i.text=i.mass.append("text").text("-mg").style("font-family","KaTeX_Math").attr("dy",10).style("text-anchor","middle").attr("y",a*d),i.lText=w.append("text").text("l").style("font-family","KaTeX_Math").style("visibility","hidden"),i.sinText=i.mass.append("text").style("font-family","KaTeX_Math").attr("dx",3).attr("dy",-3),i.sinText.style("visibility","hidden"),i.sinText.append("tspan").text("-mg "),i.sinText.append("tspan").style("font-family","KaTeX_Main").text("sin"),i.sinText.append("tspan").text(" θ"),i});p.append("g");const J=k;function E(h,i=null){const F=h/x;I.forEach(_=>{const z=i===null?J(F):i,[T,g]=[Math.cos(z),Math.sin(z)],j=v/2*y*.9*g,Y=v/2*(y*.9*T);_.line.attr("x2",j).attr("y2",Y),_.mass.attr("transform",`translate(${j},${Y})`),_.lText.attr("x",j/2).attr("y",Y/2).attr("dx",10*-T).attr("dy",15*g).attr("text-anchor","middle").attr("alignment-baseline","middle");const S=Math.sign(-g*T);_.radialForce.attr("x1",S*g*g*d*5).attr("y1",S*T*g*d*5+a*d).attr("x2",-a*g*T*d).attr("y2",a*g*g*d),_.torqueForce.attr("x2",-75*T*g*d).attr("y2",(a-5)*g*g*d),_.tanArrowhead.attr("d",l(0,0,-a*T*g*d,a*g*g*d)),_.radArrowhead.attr("d",l(-a*T*g*d,a*g*g*d,0,a*d));const H=g;_.sinText.attr("x",-a*H*T*d).attr("y",a*H*g*d).attr("dx",S>0?3:-3).attr("text-anchor",S>0?"start":"end");const R=Math.cos(Math.max(z,0)),X=Math.sin(Math.max(z,0));V.attr("d",l(X*15.25-R,R*15.25+X,X*15.5,R*15.5,{length:8,width:7,inset:1.5}));const U=Math.max(z,0)*.5;C.attr("x",Math.sin(U)*15.5).attr("y",Math.cos(U)*15.5)}),K.attr("d",u.arc().innerRadius(15).outerRadius(16).startAngle(Math.PI).endAngle(Math.PI-(i===null?J(F):i))),i===null&&(q=requestAnimationFrame(E))}function B(h){const i=p.node().getBoundingClientRect(),F=h.clientX-i.left-$/2,_=h.clientY-i.top-v/2;E(null,Math.atan2(F,_))}function D(){p.node().addEventListener("mousemove",B),I[0].sinText.style("visibility","visible"),I[0].lText.style("visibility","visible"),cancelAnimationFrame(q),q=null}function O(){I[0].sinText.style("visibility","hidden"),I[0].lText.style("visibility","hidden"),p.node().removeEventListener("mousemove",B),q===null&&(q=requestAnimationFrame(E))}function P(h){D(),h.preventDefault(),h.stopPropagation(),B({clientX:h.touches[0].clientX,clientY:h.touches[0].clientY})}function W(h){h.preventDefault(),h.stopPropagation(),B({clientX:h.touches[0].clientX,clientY:h.touches[0].clientY})}function N(h){h.touches.length||O()}p.node().addEventListener("mouseover",D),p.node().addEventListener("mouseout",O),p.node().addEventListener("touchstart",P),p.node().addEventListener("touchmove",W),p.node().addEventListener("touchend",N);let A;setTimeout(()=>{A=new c(function([h]){h.isIntersecting?q||(q=requestAnimationFrame(E)):(cancelAnimationFrame(q),q=null)}),A.observe(p.node())},1),b.then(()=>{cancelAnimationFrame(q),A&&A.disconnect()});let q=requestAnimationFrame(E);return e`<figure>
    ${p.node()}
...
Recall that ${t`\mathrm{sech}(u) \equiv 1/\mathrm{cosh}(u).`} So in this sense they sort of interpolate between the [trigonometric](https://en.wikipedia.org/wiki/Trigonometric_functions) and [hyperbolic](https://en.wikipedia.org/wiki/Hyperbolic_functions) functions. Very cool. See [Jacobi Elliptic Functions in the Complex Plane](https://observablehq.com/@rreusser/jacobi-elliptic-functions-in-the-complex-plane) for an even lovelier view of how this generalization works.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-769"),expanded:[],variables:[]},{id:769,body:(e,t,n,r,o,u,l,c,b,f,x)=>{let y;e<1?y=t(e):e===1?y=10:y=t(1/e)/Math.sqrt(e);const m=501,k=[...Array(m).keys()].map(a=>(a/(m-1)*5-.5)*y),$=k.map(a=>{const d=a/y;let v,p,w;v=n(a,e),p=r(a,e),w=o(a,e);const M=u(a,e),K=p*p+(1-e)*v*v-w*w;return{am:M,uK:d,u:a,sn:v,cn:p,dn:w,am:M,checksum:K}});return l(c.html`<figure style="max-width:100%">${b.plot({width:Math.min(640,f),height:300,grid:!0,x:{label:"u / K →",ticks:4},y:{},marks:[b.ruleY([0]),b.line($,{x:"uK",y:"sn",stroke:"#c39"}),b.line($,{x:"uK",y:"cn",stroke:"#9c3"}),b.line($,{x:"uK",y:"dn",stroke:"#39c"})].filter(a=>a)})}<figcaption>
...
Let's plot it!`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-5"),expanded:[],variables:[]},{id:5,body:function(t){return t`g = ${9.81} m/s²`},inputs:["fmt"],outputs:void 0,output:"viewof$g",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});s({root:document.getElementById("cell-4"),expanded:[],variables:[]},{id:4,body:function(t){return t`l = ${100*(12*.0254)} m`},inputs:["fmt"],outputs:void 0,output:"viewof$l",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});s({root:document.getElementById("cell-48"),expanded:[],variables:[]},{id:48,body:function(t,n,r,o,u,l,c,b){const f=t*t,x=f===1?2:n(f),y=Math.sqrt(r/o);return[...u(0,4*x,401)].map(m=>({u:m,t:m*Math.sqrt(o/r),uK:m/x,theta:2*Math.asin(t*l(m,f)),dtheta:2*t*c(m,f),x:2*t*o*l(m,f)*b(m,f),xdot:2*t*o*c(m,f)*(2*b(m,f)**2-1)*y,xddot:-2*t*o*l(m,f)*b(m,f)*(6*b(m,f)**2+4*f-5)*y**2}))},inputs:["k","ellipk","g","l","linspace","sn","cn","dn"],outputs:void 0,output:"trajectory",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-41"),expanded:[],variables:[]},{id:41,body:function(e,t,n,r,o){return e.html`<figure>${t.plot({width:Math.min(n,640),height:200,grid:!0,x:{label:"t →"},y:{label:"θ(t) ↑",domain:[-Math.PI,Math.PI]},marks:[t.ruleY([0]),t.ruleY([-Math.PI,Math.PI],{strokeDasharray:"4,4"}),t.line(r,{x:"t",y:"theta",stroke:"#c39"})]})}<figcaption>Angle ${o`\theta`} of a pendulum which starts at ${o`\theta(t = 0) = 0`} with an initial velocity.</figcaption></figure>`},inputs:["htl","Plot","width","trajectory","tex"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-32"),expanded:[],variables:[]},{id:32,body:function(e,t,n){return e.bind(e.range([0,.9999999],{label:t`k \;\;(= \sqrt{m})`,step:1e-7}),n)},inputs:["Inputs","tex","viewof$k"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});s({root:document.getElementById("cell-283"),expanded:[],variables:[]},{id:283,body:(e,t)=>e`Note that as ${t`k`} approaches ${t`1`}, the period diverges to infinity. This just reflects the fact that if the pendulum (asymptotically) makes it all the way to the top, ${t`\theta = \pm \pi`}, it takes forever to get there, equivalent to an infinitely long period.
...
This is the horizontal distance from the pivot to the mass when the mass reaches its maximum horizontal velocity. This is also therefore the distance from the gates at which we—er, the _orcs_—should place the pivot of the pole. Substituting some numbers, we get`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-395"),expanded:[],variables:[]},{id:395,body:(e,t)=>e`d_initial = ${t*Math.sqrt(1-4/9)} m`,inputs:["fmt","l"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-761"),expanded:[],variables:[]},{id:761,body:async()=>{const[{default:e},{default:t},{default:n}]=await Promise.all([L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/array-linspace/+esm"),[]).then(c=>{if(!("default"in c))throw new SyntaxError("export 'default' not found");return c}),L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/math-base-special-ellipk/+esm"),[]).then(c=>{if(!("default"in c))throw new SyntaxError("export 'default' not found");return c}),L(()=>import("https://cdn.jsdelivr.net/npm/@stdlib/math-base-special-ellipj/+esm"),[]).then(c=>{if(!("default"in c))throw new SyntaxError("export 'default' not found");return c})]),{sn:r,cn:o,dn:u,am:l}=n;return{linspace:e,ellipk:t,jacobi:n,sn:r,cn:o,dn:u,am:l}},inputs:[],outputs:["linspace","ellipk","jacobi","sn","cn","dn","am"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-12"),expanded:[],variables:[]},{id:12,body:e=>({fmt:e(".3f")}),inputs:["createFmt"],outputs:["fmt"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-7"),expanded:[],variables:[]},{id:7,body:async(e,t)=>{const{fmt:n,sci:r}=await L(()=>import("https://api.observablehq.com/@rreusser/fmt.js?v=4"),[]).then(o=>{const u={},l=e.module(o.default),c=e.module();if(!l.defines("fmt"))throw new SyntaxError("export 'fmt' not found");if(c.variable(u.fmt=t()).import("fmt",l),!l.defines("sci"))throw new SyntaxError("export 'sci' not found");return c.variable(u.sci=t()).import("sci",l),u});return{createFmt:n,sci:r}},inputs:["__ojs_runtime","__ojs_observer"],outputs:["createFmt","sci"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});s({root:document.getElementById("cell-676"),expanded:[],variables:[]},{id:676,body:()=>{function e(t,n,r,o,{length:u=10,width:l=8,shift:c=0,inset:b=2}={}){const f=r-t,x=o-n,y=Math.sqrt(f*f+x*x),m=f/y,k=x/y,$=-k,a=m,d=r-u*m,v=o-u*k,p=c*m,w=c*k;return`M${r+p},${o+w}L${d+$*l/2+p},${v+a*l/2+w}L${d+b*m+p},${v+b*k+w}L${d-$*l/2+p},${v-a*l/2+w}Z`}return{arrowhead:e}},inputs:[],outputs:["arrowhead"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});
