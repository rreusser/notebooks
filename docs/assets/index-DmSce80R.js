import{d,_ as z}from"./index-ByB2dbry.js";d({root:document.getElementById("cell-1251"),expanded:[],variables:[]},{id:1251,body:(e,t)=>e`This notebook visualizes the strange attractors of [Clifford Pickover](http://paulbourke.net/fractals/clifford/) and [Peter de Jong](http://paulbourke.net/fractals/peterdejong/). You can pan and zoom with the mouse or a touch screen. Clifford attractors are defined by
...
For more on computing attractors in WebGL, Mike Bostock's [Making WebGL Dance](https://observablehq.com/@mbostock/making-webgl-dance) is a great walkthrough. See also his [Clifford Attractor](https://observablehq.com/@mbostock/clifford-attractor) series and Yuri Vishnevsky's [Strange Attractors](https://observablehq.com/@twitter/strange-attractors).`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});d({root:document.getElementById("cell-1252"),expanded:[],variables:[]},{id:1252,body:async()=>{const[{reglCanvas:e},{default:t},n]=await Promise.all([z(()=>import("./regl-canvas-DbKbmlCP.js"),[]).then(r=>{if(!("reglCanvas"in r))throw new SyntaxError("export 'reglCanvas' not found");return r}),z(()=>import("https://cdn.jsdelivr.net/npm/regl@2.1.1/+esm"),[]).then(r=>{if(!("default"in r))throw new SyntaxError("export 'default' not found");return r}),z(()=>import("https://cdn.jsdelivr.net/npm/d3@7/+esm"),[])]);return{reglCanvas:e,createREGL:t,d3:n}},inputs:[],outputs:["reglCanvas","createREGL","d3"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-365"),expanded:[],variables:[]},{id:365,body:function(e,t,n){return e`\mathrm{accumulated\;points} = ${(t*n*n).toLocaleString()}`},inputs:["tex","accumulateCount","stateSize"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-81"),expanded:[],variables:[]},{id:81,body:(e,t,n)=>{const r=e(t.radio(["Clifford","de Jong"],{label:"Type",value:n.has("type")?n.get("type"):"Clifford"})),o=e(t.range([-2.5,2.5],{value:n.has("a")?+n.get("a"):-1.85,label:"a",step:.001})),a=e(t.range([-2.5,2.5],{value:n.has("b")?+n.get("b"):-2.5,label:"b",step:.001})),i=e(t.range([-2.5,2.5],{value:n.has("c")?+n.get("c"):-1.05,label:"c",step:.001})),u=e(t.range([-2.5,2.5],{value:n.has("d")?+n.get("d"):.585,label:"d",step:.001})),s=e(t.checkbox(["Simulate"],{value:["Simulate"]}));return{type:r,a:o,b:a,c:i,d:u,simulate:s}},inputs:["view","Inputs","parsedURL"],outputs:["type","a","b","c","d","simulate"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1253"),expanded:[],variables:[]},{id:1253,body:(e,t,n)=>({_regl:e(t(n,{attributes:{antialias:!1,depthStencil:!1,preserveDrawingBuffer:!0},extensions:["OES_texture_float","OES_texture_half_float"]}))}),inputs:["view","reglCanvas","createREGL"],outputs:["_regl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1254"),expanded:[],variables:[]},{id:1254,body:(e,t)=>({regl:function(){const r=e._gl.canvas;return r.style.maxWidth="100%",r.style.height="auto",r.style.cursor="move",r.style.border="1px solid #ccc",e.attachResize(t.width,t.height)}()}),inputs:["_regl","viewport"],outputs:["regl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-649"),expanded:[],variables:[]},{id:649,body:(e,t,n)=>{const r=e(t.checkbox(["Invert","Flip colorscale"],{value:[...n.get("invert")==="true"?["Invert"]:[],...n.get("flip")==="true"?["Flip colorscale"]:[]]})),o=e(t.range([-.5,1.5],{value:n.has("brightness")?+n.get("brightness"):.3,label:"Brightness"})),a=e(t.range([.1,2],{value:n.has("contrast")?+n.get("contrast"):1,label:"Contrast"})),i=e(t.range([0,1],{value:n.has("saturation")?+n.get("saturation"):.8,label:"Saturation"})),u=e(t.range([.1,1],{value:n.has("dynamicRange")?+n.get("dynamicRange"):.2,label:"Dynamic range compression",transform:Math.log})),s=e(t.range([.1,2],{value:n.has("colorSpeed")?+n.get("colorSpeed"):.22,label:"Color speed",transform:Math.log})),f=e(t.range([0,360],{value:n.has("colorPhase")?+n.get("colorPhase"):180,label:"Color phase"})),p=e(t.range([.1,10],{value:n.has("gamma")?+n.get("gamma"):2.2,label:"Gamma",transform:Math.log})),c=e(t.range([5e5,4e6],{value:5e5,label:"Batch size",transform:Math.log,step:2})),m=e(t.range([1,50],{value:25,label:"Iterations",step:1})),b=e(t.range([0,3],{value:1.5,label:"AA Jitter (pixels)",step:.1})),v=e(t.select(["256 × 256","512 × 512","1024 × 1024","2048 × 2048","1680 × 1050","page width"],{value:"page width",label:`Size (dpi = ${window.devicePixelRatio})`})),l=e(t.radio(["cpu","gpu"],{value:"gpu",label:"Computation mode"}));return{opts:r,brightness:o,contrast:a,saturation:i,dynamicRange:u,colorSpeed:s,colorPhase:f,gamma:p,batchSize:c,iterations:m,jitter:b,size:v,mode:l}},inputs:["view","Inputs","parsedURL"],outputs:["opts","brightness","contrast","saturation","dynamicRange","colorSpeed","colorPhase","gamma","batchSize","iterations","jitter","size","mode"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-650"),expanded:[],variables:[]},{id:650,body:(e,t,n,r,o)=>({floatFormat:e(t.radio(["float","half float"],{value:n(r,"float")?"float":"half float",label:o`Floating format<br><em><small>switch to half float on mobile if float doesn't work</small></em>`}))}),inputs:["view","Inputs","canWriteToFBOOfType","regl","html"],outputs:["floatFormat"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1753"),expanded:[],variables:[]},{id:1753,body:function(t,n,r,o,a,i,u,s,f,p,c,m,b){const v=new URL(document.baseURI),l=v.searchParams;return l.set("type",t),l.set("a",n),l.set("b",r),l.set("c",o),l.set("d",a),l.set("brightness",i),l.set("contrast",u),l.set("gamma",s),l.set("saturation",f),l.set("colorSpeed",p),l.set("colorPhase",c),l.set("invert",!!~m.indexOf("Invert")),l.set("flip",!!~m.indexOf("Flip colorscale")),b`<a href="${v.toString()}">🔗 Link to this configuration</a>`},inputs:["type","a","b","c","d","brightness","contrast","gamma","saturation","colorSpeed","colorPhase","opts","html"],outputs:void 0,output:"link",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1594"),expanded:[],variables:[]},{id:1594,body:function(e,t,n,r,o,a,i,u){const s=e.button("Download PNG"),f=`${t==="Clifford"?"clifford":"de-jong"}_a${n.toFixed(4)}_b${r.toFixed(4)}_c${o.toFixed(4)}_d${a.toFixed(4)}.png`;return s.addEventListener("input",()=>{i(u._gl.canvas.toDataURL(),f)}),s},inputs:["Inputs","type","a","b","c","d","downloadURI","regl"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-162"),expanded:[],variables:[]},{id:162,body:function(t){return t.button("Restart")},inputs:["Inputs"],outputs:void 0,output:"viewof$restart",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});d({root:document.getElementById("cell-157"),expanded:[],variables:[]},{id:157,body:function(){return 0},inputs:[],outputs:void 0,output:"mutable accumulateCount",assets:void 0,autodisplay:!0,autoview:!1,automutable:!0});d({root:document.getElementById("cell-865"),expanded:[],variables:[]},{id:865,body:function(){return!0},inputs:[],outputs:void 0,output:"mutable dirty",assets:void 0,autodisplay:!0,autoview:!1,automutable:!0});d({root:document.getElementById("cell-1767"),expanded:[],variables:[]},{id:1767,body:e=>({parsedURL:new Map(Object.entries(e(document.location.search)))}),inputs:["parseQueryString"],outputs:["parsedURL"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1702"),expanded:[],variables:[]},{id:1702,body:(e,t)=>({shape:e==="page width"?[t,t]:e.split("×").map(r=>parseInt(r.trim(),10))}),inputs:["size","width"],outputs:["shape"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1288"),expanded:[],variables:[]},{id:1288,body:function(e,t,n,r,o,a,i){i.value=!0},inputs:["opts","brightness","contrast","gamma","saturation","dynamicRange","mutable$dirty"],outputs:void 0,output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1478"),expanded:[],variables:[]},{id:1478,body:e=>({iterationArray:new Array(e*4).fill(0)}),inputs:["batchSize"],outputs:["iterationArray"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1485"),expanded:[],variables:[]},{id:1485,body:(e,t,n)=>({cpuPositionBuffer:function(){const o=e.buffer(t);return n.then(()=>o.destroy()),o}()}),inputs:["regl","iterationArray","invalidation"],outputs:["cpuPositionBuffer"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1473"),expanded:[],variables:[]},{id:1473,body:(e,t,n,r,o)=>{function a(i){let u,s,f,p,c,m;e==="Clifford"?(u=t,s=n,f=t,p=r,c=o,m=r):(u=t,s=-1,f=r,p=n,c=-1,m=o);for(let b=0;b<i.length;b+=4){let v=i[b],l=i[b+1],y=Math.sin(u*l)+s*Math.cos(f*v),h=Math.sin(p*v)+c*Math.cos(m*l),w=y-v,g=h-l;i[b]=y,i[b+1]=h,i[b+2]=Math.sqrt(w*w+g*g),i[b+3]=b>>2}}return{iterate:a}},inputs:["type","a","c","b","d"],outputs:["iterate"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1515"),expanded:[],variables:[]},{id:1515,body:(e,t,n,r,o,a)=>{function i(u){let s=Math.random()*2-1,f=Math.random()*2-1,p=Math.sqrt(e),c,m,b,v,l,y;t==="Clifford"?(c=n,m=r,b=n,v=o,l=a,y=o):(c=n,m=-1,b=o,v=r,l=-1,y=a);for(let h=0;h<u.length;h+=4){let w=u.length*Math.random(),g=4*(w/2%p)/p+s,x=4*w/2/p/p+f;for(let S=0;S<15;S++){let B=Math.sin(c*x)+m*Math.cos(b*g),I=Math.sin(v*g)+l*Math.cos(y*x);g=B,x=I}u[h]=g,u[h+1]=x}}return{cpuInitialize:i}},inputs:["batchSize","type","a","c","b","d"],outputs:["cpuInitialize"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-1496"),expanded:[],variables:[]},{id:1496,body:(e,t)=>({cpuAccumulate:e({vert:`
  ...
  }`,attributes:{position:e.prop("cpuBuffer")},uniforms:{resolution:({framebufferWidth:r,framebufferHeight:o})=>[r,o],colorSpeed:e.prop("colorSpeed"),colorPhase:e.prop("colorPhase"),colorSign:e.prop("colorSign"),pointSize:e.prop("pointSize"),jitter:e.prop("jitter")},blend:{enable:!0,func:{srcRGB:1,srcAlpha:1,dstRGB:1,dstAlpha:1},equation:{rgb:"add",alpha:"add"}},framebuffer:e.prop("dst"),primitive:"points",depth:{enable:!1},count:t})}),inputs:["regl","batchSize"],outputs:["cpuAccumulate"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-906"),expanded:[],variables:[]},{id:906,body:(e,t,n)=>({scales:function(){const o=e.width/e.height,a=t.scaleLinear().range([0,n._gl.canvas.offsetWidth]).domain([-2.2*o,2.2*o]),i=t.scaleLinear().range([n._gl.canvas.offsetWidth,0]).domain([-2.2,2.2]);return{x:a,y:i,xOriginal:a.copy(),yOriginal:i.copy()}}()}),inputs:["viewport","d3","regl"],outputs:["scales"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-824"),expanded:[],variables:[]},{id:824,body:(e,t,n,r)=>({attachZoom:function(){function a(i,u,s,f,p){return e.zoom().on("zoom",function({transform:c}){let m;m=i.range().map(c.invertX,c),i.domain(s.domain()),i.domain(m.map(i.invert,i)),m=u.range().map(c.invertY,c),u.domain(f.domain()),u.domain(m.map(u.invert,u))})}e.select(t._gl.canvas).call(a(n.x,n.y,n.xOriginal,n.yOriginal).on("zoom.clearAccumulator",()=>{t.poll(),r()}))}()}),inputs:["d3","regl","scales","clearAccumulator"],outputs:["attachZoom"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-41"),expanded:[],variables:[]},{id:41,body:e=>({stateSize:Math.floor(Math.sqrt(e))}),inputs:["batchSize"],outputs:["stateSize"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-754"),expanded:[],variables:[]},{id:754,body:e=>({viewport:{width:e[0],height:e[1],dpi:devicePixelRatio,margin:{t:0,r:0,b:0,l:0}}}),inputs:["shape"],outputs:["viewport"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-934"),expanded:[],variables:[]},{id:934,body:()=>{function e(t){const n=t.x.domain()[1]-t.x.domain()[0],r=t.xOriginal.domain()[1]-t.xOriginal.domain()[0],o=t.y.domain()[1]-t.y.domain()[0],a=t.yOriginal.domain()[1]-t.yOriginal.domain()[0];return n*o/(r*a)}return{scaleFactor:e}},inputs:[],outputs:["scaleFactor"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-875"),expanded:[],variables:[]},{id:875,body:function(t,n,r){return function(){t.use(()=>n.clear({color:[0,0,0,0]})),r.value=0}},inputs:["accumulator","regl","mutable$accumulateCount"],outputs:void 0,output:"clearAccumulator",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-166"),expanded:[],variables:[]},{id:166,body:function(t,n,r,o,a,i,u,s,f,p,c,m,b,v,l,y){m==="cpu"&&b(v),l.poll(),y()},inputs:["restart","iterations","batchSize","jitter","type","a","b","c","d","colorSpeed","colorPhase","mode","cpuInitialize","iterationArray","regl","clearAccumulator"],outputs:void 0,output:"performInitialization",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-71"),expanded:[],variables:[]},{id:71,body:function(t,n,r,o,a,i,u,s,f,p,c,m,b,v,l,y,h,w,g,x,S,B,I,E,_,C,F,M,P,R,V,q,O,T){const A=t.frame(({tick:W})=>{try{(~n.indexOf("Simulate")||r.value===0)&&(r.value===1&&o.use(()=>t.clear({color:[0,0,0,0]})),a==="cpu"&&((r.value+1)%i===0&&u(s),f(s),p.subdata(s)),c(m,k=>{b(v.x,v.y,j=>{(a==="cpu"?l:y)({a:h,b:w,c:g,d:x,cpuBuffer:p,dst:o,colorSpeed:S,jitter:B,colorPhase:I*Math.PI/180,colorSign:~E.indexOf("Flip colorscale")?-1:1,pointSize:r.value===0?2:1})})}),_.value=!0,r.value=r.value+1),_.value&&(C({src:o,opacity:1,brightness:F,contrast:M,accumulatorCount:Math.max(1,r.value),batchSize:P*P,gamma:R,dynamicRange:V,scaleFactor:q(v),invert:!!~E.indexOf("Invert"),saturation:O}),_.value=!1)}catch(k){console.error(k),A.cancel()}});T.then(()=>A.cancel())},inputs:["regl","simulate","mutable$accumulateCount","accumulator","mode","iterations","cpuInitialize","iterationArray","iterate","cpuPositionBuffer","configureViewport","viewport","configureScales","scales","cpuAccumulate","gpuAccumulate","a","b","c","d","colorSpeed","jitter","colorPhase","opts","mutable$dirty","copyToScreen","brightness","contrast","stateSize","gamma","dynamicRange","scaleFactor","saturation","invalidation"],outputs:void 0,output:"performIteration",assets:void 0,autodisplay:!0,autoview:!1,automutable:!1});d({root:document.getElementById("cell-1365"),expanded:[],variables:[]},{id:1365,body:(e,t,n)=>({randobuffer:function(){const o=Float32Array.from(Array.from(Array(e).keys())),a=t.buffer(o);return n.then(()=>a.destroy()),a}()}),inputs:["batchSize","regl","invalidation"],outputs:["randobuffer"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});d({root:document.getElementById("cell-59"),expanded:[],variables:[]},{id:59,body:(e,t,n,r,o)=>({gpuAccumulate:e({vert:`
  precision highp float;
  attribute float n;
  uniform mat3 view3;
