function ve(c,e){const[t,r,i,a,s,n,o,l,h,p,d,f,_,m,g,v]=e,x=t*n-r*s,y=t*o-i*s,S=t*l-a*s,E=r*o-i*n,A=r*l-a*n,b=i*l-a*o,I=h*m-p*_,D=h*g-d*_,U=h*v-f*_,T=p*g-d*m,w=p*v-f*m,G=d*v-f*g;let R=x*G-y*w+S*T+E*U-A*D+b*I;return Math.abs(R)<1e-10?!1:(R=1/R,c[0]=(n*G-o*w+l*T)*R,c[1]=(-r*G+i*w-a*T)*R,c[2]=(m*b-g*A+v*E)*R,c[3]=(-p*b+d*A-f*E)*R,c[4]=(-s*G+o*U-l*D)*R,c[5]=(t*G-i*U+a*D)*R,c[6]=(-_*b+g*S-v*y)*R,c[7]=(h*b-d*S+f*y)*R,c[8]=(s*w-n*U+l*I)*R,c[9]=(-t*w+r*U-a*I)*R,c[10]=(_*A-m*S+v*x)*R,c[11]=(-h*A+p*S-f*x)*R,c[12]=(-s*T+n*D-o*I)*R,c[13]=(t*T-r*D+i*I)*R,c[14]=(-_*E+m*y-g*x)*R,c[15]=(h*E-p*y+d*x)*R,!0)}function st(c){function e(s,n,o){const l=c[0]*s+c[4]*n+c[8]*o+c[12],h=c[1]*s+c[5]*n+c[9]*o+c[13],p=c[2]*s+c[6]*n+c[10]*o+c[14],d=c[3]*s+c[7]*n+c[11]*o+c[15];return[l/d,h/d,p/d]}const t=.3,r=.99,i=new Float32Array(24),a=[[-1,-1],[1,-1],[1,1],[-1,1]];for(let s=0;s<4;s++){const[n,o]=a[s],l=e(n,o,t),h=e(n,o,r);i[s*3]=l[0],i[s*3+1]=l[1],i[s*3+2]=l[2],i[(s+4)*3]=h[0],i[(s+4)*3+1]=h[1],i[(s+4)*3+2]=h[2]}return i}function ot(c,e={}){const t={center:e.center?[...e.center]:[0,0,0],distance:e.distance||10,phi:e.phi||0,theta:e.theta||.3,fov:e.fov||Math.PI/4,near:e.near||.1,far:e.far||1},r=e.rotateSpeed||.01,i=e.zoomSpeed||.001,a=e.panSpeed||1,s=new Float32Array(16),n=new Float32Array(16),o=new Float32Array(16),l=new Float32Array(16);let h=!0,p=1,d=!1,f=null,_=0,m=0,g=null,v=null;function x(u){const{phi:B,theta:z,distance:C,center:P}=t,L=P[0]+C*Math.cos(z)*Math.cos(B),k=P[1]+C*Math.sin(z),O=P[2]+C*Math.cos(z)*Math.sin(B),X=L-u[0],Q=k-u[1],q=O-u[2],W=Math.sqrt(X*X+Q*Q+q*q);if(W<1e-10)return;t.center[0]=u[0],t.center[1]=u[1],t.center[2]=u[2],t.distance=W,t.theta=Math.asin(Math.max(-1,Math.min(1,Q/W)));const K=Math.cos(t.theta);t.phi=K>1e-10?Math.atan2(q,X):t.phi}function y(u,B){const z=c.getBoundingClientRect(),C=(u-z.left)/z.width*2-1,P=1-(B-z.top)/z.height*2;ve(l,o);const L=l;function k(Q,q,W){const K=L[0]*Q+L[4]*q+L[8]*W+L[12],ee=L[1]*Q+L[5]*q+L[9]*W+L[13],se=L[2]*Q+L[6]*q+L[10]*W+L[14],J=L[3]*Q+L[7]*q+L[11]*W+L[15];return[K/J,ee/J,se/J]}const O=k(C,P,0),X=k(C,P,1);return{origin:O,direction:[X[0]-O[0],X[1]-O[1],X[2]-O[2]]}}function S(u,B){if(Math.abs(u.direction[1])<1e-10)return null;const z=(B-u.origin[1])/u.direction[1];return z<0?null:[u.origin[0]+z*u.direction[0],B,u.origin[2]+z*u.direction[2]]}let E=0,A=0,b=0;function I(u){const{phi:B,theta:z,distance:C,center:P,fov:L,near:k,far:O}=t,X=P[0]+C*Math.cos(z)*Math.cos(B),Q=P[1]+C*Math.sin(z),q=P[2]+C*Math.cos(z)*Math.sin(B);let W=P[0]-X,K=P[1]-Q,ee=P[2]-q;const se=Math.sqrt(W*W+K*K+ee*ee);W/=se,K/=se,ee/=se;let J=K*0-ee*1,oe=ee*0-W*0,re=W*1-K*0;const ne=Math.sqrt(J*J+oe*oe+re*re);ne>1e-4&&(J/=ne,oe/=ne,re/=ne);const ae=oe*ee-re*K,le=re*W-J*ee,te=J*K-oe*W;s[0]=J,s[1]=ae,s[2]=-W,s[3]=0,s[4]=oe,s[5]=le,s[6]=-K,s[7]=0,s[8]=re,s[9]=te,s[10]=-ee,s[11]=0,s[12]=-(J*X+oe*Q+re*q),s[13]=-(ae*X+le*Q+te*q),s[14]=W*X+K*Q+ee*q,s[15]=1;const H=1/Math.tan(L/2),fe=1/(k-O);n[0]=H/u,n[1]=0,n[2]=0,n[3]=0,n[4]=0,n[5]=H,n[6]=0,n[7]=0,n[8]=0,n[9]=0,n[10]=O*fe,n[11]=-1,n[12]=0,n[13]=0,n[14]=k*O*fe,n[15]=0;for(let de=0;de<4;de++)for(let Se=0;Se<4;Se++){let ze=0;for(let Me=0;Me<4;Me++)ze+=n[de+Me*4]*s[Me+Se*4];o[de+Se*4]=ze}}function D(u,B){const{phi:z,theta:C,distance:P}=t,L=Math.sin(z),k=-Math.cos(z),O=-Math.sin(C)*Math.cos(z),X=Math.cos(C),Q=-Math.sin(C)*Math.sin(z),q=P*a;t.center[0]-=u*L*q,t.center[0]+=B*O*q,t.center[1]+=B*X*q,t.center[2]-=u*k*q,t.center[2]+=B*Q*q}function U(u,B){if(v=null,I(p),g){const P=g(u,B);if(Array.isArray(P)&&P.length===3){v={point:[...P],altitude:P[1]};return}}const z=y(u,B),C=S(z,t.center[1]);C&&(v={point:C,altitude:t.center[1]})}function T(u,B){if(!v)return;I(p);const z=y(u,B),C=S(z,v.altitude);C&&(t.center[0]+=v.point[0]-C[0],t.center[2]+=v.point[2]-C[2])}function w(u){if(u.preventDefault(),_=u.clientX,m=u.clientY,f=u.shiftKey?"pan":u.button===2||u.button===1?"rotate":u.ctrlKey?"pivot":u.metaKey?"rotate":"grab",f==="rotate"&&g){const B=c.getBoundingClientRect(),z=g(B.left+B.width/2,B.top+B.height/2);Array.isArray(z)&&z.length===3&&x(z)}f==="grab"&&U(u.clientX,u.clientY),d=!0,c.style.cursor="grabbing",window.addEventListener("mousemove",G),window.addEventListener("mouseup",R)}function G(u){if(!d)return;const B=u.clientX-_,z=u.clientY-m;if(_=u.clientX,m=u.clientY,f==="grab")T(u.clientX,u.clientY);else if(f==="rotate")t.phi+=B*r,t.theta=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,t.theta+z*r));else if(f==="pivot"){const{phi:C,theta:P,distance:L,center:k,fov:O}=t,X=O/c.getBoundingClientRect().height,Q=k[0]+L*Math.cos(P)*Math.cos(C),q=k[1]+L*Math.sin(P),W=k[2]+L*Math.cos(P)*Math.sin(C);t.phi-=B*X,t.theta=Math.max(-Math.PI/2+.01,Math.min(Math.PI/2-.01,t.theta-z*X)),t.center[0]=Q-L*Math.cos(t.theta)*Math.cos(t.phi),t.center[1]=q-L*Math.sin(t.theta),t.center[2]=W-L*Math.cos(t.theta)*Math.sin(t.phi)}else if(f==="pan"){const C=c.getBoundingClientRect();D(B/C.height,z/C.height)}h=!0}function R(){d=!1,f=null,v=null,c.style.cursor="grab",window.removeEventListener("mousemove",G),window.removeEventListener("mouseup",R)}let Y=!1,V=null;function j(u){if(u.preventDefault(),!Y&&g){const X=g(u.clientX,u.clientY);if(Array.isArray(X)&&X.length===3){const{phi:Q,theta:q,distance:W,center:K}=t,ee=K[0]+W*Math.cos(q)*Math.cos(Q),se=K[1]+W*Math.sin(q),J=K[2]+W*Math.cos(q)*Math.sin(Q),oe=X[0]-ee,re=X[1]-se,ne=X[2]-J,ae=Math.sqrt(oe*oe+re*re+ne*ne),le=Math.cos(q)*Math.cos(Q),te=Math.sin(q),H=Math.cos(q)*Math.sin(Q);t.center[0]+=(W-ae)*le,t.center[1]+=(W-ae)*te,t.center[2]+=(W-ae)*H,t.distance=ae}Y=!0}clearTimeout(V),V=setTimeout(()=>{Y=!1},200);const B=c.getBoundingClientRect(),z=(u.clientX-B.left-B.width/2)/B.height,C=(u.clientY-B.top-B.height/2)/B.height,P=1+u.deltaY*i,L=t.distance;t.distance=Math.max(t.near*2,L*P);const O=1-t.distance/L;D(-z*O,-C*O),h=!0}function N(u){if(u.preventDefault(),u.touches.length===1)d=!0,f="grab",_=u.touches[0].clientX,m=u.touches[0].clientY,U(_,m);else if(u.touches.length===2){const B=u.touches[1].clientX-u.touches[0].clientX,z=u.touches[1].clientY-u.touches[0].clientY;E=Math.sqrt(B*B+z*z),A=(u.touches[0].clientX+u.touches[1].clientX)/2,b=(u.touches[0].clientY+u.touches[1].clientY)/2}}function Z(u){if(u.preventDefault(),u.touches.length===1&&d)_=u.touches[0].clientX,m=u.touches[0].clientY,f==="grab"&&T(_,m),h=!0;else if(u.touches.length===2){const B=u.touches[1].clientX-u.touches[0].clientX,z=u.touches[1].clientY-u.touches[0].clientY,C=Math.sqrt(B*B+z*z),P=(u.touches[0].clientX+u.touches[1].clientX)/2,L=(u.touches[0].clientY+u.touches[1].clientY)/2;if(E>0){const k=E/C;t.distance*=k,t.distance=Math.max(t.near*2,t.distance);const O=c.getBoundingClientRect(),X=(P-A)/O.height,Q=(L-b)/O.height;D(X,Q),h=!0}E=C,A=P,b=L}}function $(){d=!1,f=null,v=null,E=0}function M(u){u.preventDefault()}c.style.cursor="grab",c.addEventListener("mousedown",w),c.addEventListener("wheel",j,{passive:!1}),c.addEventListener("touchstart",N,{passive:!1}),c.addEventListener("touchmove",Z,{passive:!1}),c.addEventListener("touchend",$),c.addEventListener("contextmenu",M);function F(){c.removeEventListener("mousedown",w),c.removeEventListener("wheel",j),c.removeEventListener("touchstart",N),c.removeEventListener("touchmove",Z),c.removeEventListener("touchend",$),c.removeEventListener("contextmenu",M),window.removeEventListener("mousemove",G),window.removeEventListener("mouseup",R)}return{state:t,get dirty(){return h},set rotateStartCallback(u){g=u},taint(){h=!0},update(u){p=u,I(u);const B=h;return h=!1,{view:s,projection:n,projectionView:o,dirty:B}},destroy:F}}function nt(c){const r=new Uint16Array(530450);let i=0;for(let d=0;d<=514;d++)for(let f=0;f<=514;f++)r[i++]=f,r[i++]=d;const s=514*514*6,n=new Uint32Array(s);let o=0;const l=515;for(let d=0;d<514;d++)for(let f=0;f<514;f++){const _=d*l+f,m=_+1,g=_+l,v=g+1;n[o++]=_,n[o++]=g,n[o++]=m,n[o++]=m,n[o++]=g,n[o++]=v}const h=c.createBuffer({size:r.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});c.queue.writeBuffer(h,0,r);const p=c.createBuffer({size:n.byteLength,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST});return c.queue.writeBuffer(p,0,n),{vertexBuffer:h,indexBuffer:p,indexCount:s,vertexCount:265225}}const Te=`
...
`,Ce=1e4,Ue=14,Ee=Ue*4;function Ve(c){const e=/^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i.exec(c);return e?[parseInt(e[1],16)/255,parseInt(e[2],16)/255,parseInt(e[3],16)/255,1]:[1,0,0,1]}class Dt{constructor(e,t,r){this._source=t,this._queryElevation=r;const i=e.paint||{};this._radius=i["circle-radius"]||4,this._fillColor=Ve(i["circle-color"]||"#ff3333"),this._strokeColor=Ve(i["circle-stroke-color"]||"#ffffff"),this._strokeWidth=i["circle-stroke-width"]||0,this._opacity=i["circle-opacity"]!=null?i["circle-opacity"]:1,this._atmosphereOpacity=i["atmosphere-opacity"]!=null?i["atmosphere-opacity"]:1,this._pipelineDepthTest=null,this._pipelineNoDepthTest=null,this._instanceBuffer=null,this._instanceData=null,this._uniformBuffer=null,this._uniformBindGroup=null,this._visibleCount=0,this._visibleFeatures=null}init(e,t,r){this._device=e;const i=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]});this._uniformBuffer=e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this._uniformBindGroup=e.createBindGroup({layout:i,entries:[{binding:0,resource:{buffer:this._uniformBuffer}}]}),this._instanceData=new Float32Array(Ce*Ue),this._instanceBuffer=e.createBuffer({size:Ce*Ee,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});const a=e.createShaderModule({code:Lt}),s=e.createShaderModule({code:Gt}),n=e.createPipelineLayout({bindGroupLayouts:[t,i]}),o={module:a,entryPoint:"vs_circle",buffers:[{arrayStride:Ee,stepMode:"instance",attributes:[{format:"float32x3",offset:0,shaderLocation:0},{format:"float32",offset:12,shaderLocation:1},{format:"float32x4",offset:16,shaderLocation:2},{format:"float32x4",offset:32,shaderLocation:3},{format:"float32",offset:48,shaderLocation:4},{format:"float32",offset:52,shaderLocation:5}]}]},l={module:s,entryPoint:"fs_circle",targets:[{format:r,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]};this._pipelineDepthTest=e.createRenderPipeline({layout:n,vertex:o,fragment:l,primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"less"}}),this._pipelineNoDepthTest=e.createRenderPipeline({layout:n,vertex:o,fragment:l,primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"always"}})}prepare(e,t,r,i,a){const s=this._source.features,n=this._instanceData;let o=0;for(let h=0;h<s.length&&o<Ce;h++){const p=s[h],d=this._queryElevation(p.mercatorX,p.mercatorY);if(d==null||d<=0||this._visibleFeatures&&!this._visibleFeatures.has(h))continue;const f=this._estimateElevScale(p.mercatorY),_=p.mercatorX,m=d*f*a,g=p.mercatorY,v=e[0]*_+e[4]*m+e[8]*g+e[12],x=e[1]*_+e[5]*m+e[9]*g+e[13],y=e[3]*_+e[7]*m+e[11]*g+e[15];if(y<=0)continue;const S=v/y,E=x/y,A=.2;if(S<-1-A||S>1+A||E<-1-A||E>1+A)continue;const b=o*Ue;n[b]=_,n[b+1]=m,n[b+2]=g,n[b+3]=this._radius,n[b+4]=this._fillColor[0],n[b+5]=this._fillColor[1],n[b+6]=this._fillColor[2],n[b+7]=this._fillColor[3],n[b+8]=this._strokeColor[0],n[b+9]=this._strokeColor[1],n[b+10]=this._strokeColor[2],n[b+11]=this._strokeColor[3],n[b+12]=this._strokeWidth,n[b+13]=this._opacity,o++}this._visibleCount=o,o>0&&this._device.queue.writeBuffer(this._instanceBuffer,0,n.buffer,0,o*Ee);const l=new Float32Array(24);l.set(e,0),l[16]=t,l[17]=r,l[18]=i,l[19]=a,l[20]=this._atmosphereOpacity,this._device.queue.writeBuffer(this._uniformBuffer,0,l)}draw(e,t,r=!0){this._visibleCount!==0&&(e.setPipeline(r?this._pipelineDepthTest:this._pipelineNoDepthTest),e.setBindGroup(0,t),e.setBindGroup(1,this._uniformBindGroup),e.setVertexBuffer(0,this._instanceBuffer),e.draw(6,this._visibleCount))}getCollisionItems(e,t,r,i,a){const s=this._source.features,n=t/i,o=r/i,l=this._radius+this._strokeWidth,h=[];for(let p=0;p<s.length;p++){const d=s[p],f=this._queryElevation(d.mercatorX,d.mercatorY);if(f==null||f<=0)continue;const _=this._estimateElevScale(d.mercatorY),m=d.mercatorX,g=f*_*a,v=d.mercatorY,x=e[0]*m+e[4]*g+e[8]*v+e[12],y=e[1]*m+e[5]*g+e[9]*v+e[13],S=e[2]*m+e[6]*g+e[10]*v+e[14],E=e[3]*m+e[7]*g+e[11]*v+e[15];if(E<=0)continue;const A=x/E,b=y/E;A<-1.2||A>1.2||b<-1.2||b>1.2||h.push({layerIndex:-1,featureIndex:p,sourceFeatureIndex:p,screenX:(A*.5+.5)*n,screenY:(.5-b*.5)*o,halfW:l,halfH:l,depth:S/E,clipW:E})}return h}setVisibleFeatures(e){this._visibleFeatures=e}_estimateElevScale(e){const r=Math.floor(e*1024);return ue(10,r)}}const Be=96,_e=Be/4;function kt(c,e){const{fontAtlas:t,vertexTransform:r=Ot,vertexProjection:i=Yt,fragmentShaderBody:a=Xt,colorTargets:s,depthStencil:n,multisample:o,initialCapacity:l=1024}=e,h=Array.isArray(s)?s:[s];let p=[],d=0,f=!1,_=0,m=l,g=c.createBuffer({label:"gpu-text-characters",size:m*Be,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),v=new Float32Array(m*_e);const x=c.createBuffer({label:"gpu-text-uniforms",size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),y=c.createSampler({label:"gpu-text-sampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}),S=qt(r,i),E=Wt(a),A=c.createShaderModule({label:"gpu-text-vertex",code:S}),b=c.createShaderModule({label:"gpu-text-fragment",code:E}),I=c.createRenderPipeline({label:"gpu-text",layout:"auto",vertex:{module:A,entryPoint:"vertexMain"},fragment:{module:b,entryPoint:"fragmentMain",targets:h},primitive:{topology:"triangle-strip",stripIndexFormat:void 0,cullMode:"none"},depthStencil:n,multisample:o}),D=c.createBindGroup({layout:I.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:x}}]});let U=T();function T(){return c.createBindGroup({layout:I.getBindGroupLayout(1),entries:[{binding:0,resource:y},{binding:1,resource:t.textureView},{binding:2,resource:{buffer:g}}]})}let w=-1,G=-1,R=!1;function Y(M){let F=0;for(const u of M)t.glyphs.has(u)&&u!==" "&&u!=="	"&&u!==`
`&&F++;return F}function V(M){if(M<=m)return;let F=m;for(;F<M;)F*=2;const u=c.createBuffer({label:"gpu-text-characters",size:F*Be,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),B=new Float32Array(F*_e);B.set(v),_>0&&c.queue.writeBuffer(u,0,B,0,_*_e),g.destroy(),g=u,v=B,m=F,U=T()}function j(M,F){let u=0,B=0,z=0;for(const C of M){if(C===" "){const O=t.glyphs.get(" ");u+=O?O.xAdvance*F:t.fontSize*.3*F;continue}if(C==="	"){const O=t.glyphs.get(" "),X=O?O.xAdvance:t.fontSize*.3;u+=X*4*F;continue}if(C===`
`)continue;const P=t.glyphs.get(C);if(!P)continue;u+=P.xAdvance*F;const L=-P.yOffset*F,k=P.height*F-L;B=Math.max(B,L),z=Math.max(z,k)}return{width:u,ascent:B,descent:z}}function N(M){const{text:F,anchor:u,offset:B,fontSize:z,color:C,strokeColor:P,strokeWidth:L,bufferOffset:k,align:O,baseline:X}=M,Q=z/t.fontSize,q=t.width,W=t.height,K=j(F,1);let ee=0;O==="center"?ee=-K.width/2:O==="right"&&(ee=-K.width);let se=0;X==="top"?se=K.ascent:X==="middle"?se=(K.ascent-K.descent)/2:X==="bottom"&&(se=-K.descent);let J=ee,oe=se,re=0;for(const le of F){if(le===" "){const fe=t.glyphs.get(" ");fe?J+=fe.xAdvance:J+=t.fontSize*.3;continue}if(le==="	"){const fe=t.glyphs.get(" "),de=fe?fe.xAdvance:t.fontSize*.3;J+=de*4;continue}if(le===`
`)continue;const te=t.glyphs.get(le);if(!te)continue;const H=(k+re)*_e;v[H+0]=te.x/q,v[H+1]=te.y/W,v[H+2]=(te.x+te.width)/q,v[H+3]=(te.y+te.height)/W,v[H+4]=C[0],v[H+5]=C[1],v[H+6]=C[2],v[H+7]=C[3],v[H+8]=u[0],v[H+9]=u[1],v[H+10]=u[2],v[H+11]=u[3],v[H+12]=P[0],v[H+13]=P[1],v[H+14]=P[2],v[H+15]=P[3],v[H+16]=J+te.xOffset,v[H+17]=oe+te.yOffset,v[H+18]=B[0],v[H+19]=B[1],v[H+20]=te.width,v[H+21]=te.height,v[H+22]=Q,v[H+23]=L,J+=te.xAdvance,re++}const ne=k*Be,ae=k*_e;c.queue.writeBuffer(g,ne,v,ae,M.characterCount*_e),M.dirty=!1}function Z(){if(!f)return;const M=p.filter(u=>!u.destroyed);let F=0;for(const u of M)u.bufferOffset!==F&&(u.bufferOffset=F,u.dirty=!0),F+=u.characterCount;_=F,p=M;for(const u of p)u.dirty&&N(u);f=!1}function $(M){return M.length===2?[M[0],M[1],0,1]:M.length===3?[M[0],M[1],M[2],1]:[M[0],M[1],M[2],M[3]]}return{createSpan(M){const F=Y(M.text);V(_+F);const u={id:d++,text:M.text,anchor:$(M.position),offset:M.offset??[0,0],fontSize:M.fontSize??t.fontSize,color:M.color?[...M.color]:[1,1,1,1],strokeColor:M.strokeColor?[...M.strokeColor]:[0,0,0,0],strokeWidth:M.strokeWidth??0,align:M.align??"left",baseline:M.baseline??"baseline",bufferOffset:_,characterCount:F,destroyed:!1,dirty:!0};return p.push(u),_+=F,N(u),{setText(B){if(u.destroyed)return;const z=Y(B);z!==u.characterCount?(u.destroyed=!0,f=!0,Z(),V(_+z),u.destroyed=!1,u.text=B,u.characterCount=z,u.bufferOffset=_,u.dirty=!0,p.push(u),_+=z):(u.text=B,u.dirty=!0),N(u)},setPosition(B){u.destroyed||(u.anchor=$(B),u.dirty=!0,N(u))},setOffset(B){u.destroyed||(u.offset=[...B],u.dirty=!0,N(u))},setFontSize(B){u.destroyed||(u.fontSize=B,u.dirty=!0,N(u))},setColor(B){u.destroyed||(u.color=[...B],u.dirty=!0,N(u))},setStrokeColor(B){u.destroyed||(u.strokeColor=[...B],u.dirty=!0,N(u))},setStrokeWidth(B){u.destroyed||(u.strokeWidth=B,u.dirty=!0,N(u))},setAlign(B){u.destroyed||(u.align=B,u.dirty=!0,N(u))},setBaseline(B){u.destroyed||(u.baseline=B,u.dirty=!0,N(u))},getText(){return u.text},getCharacterCount(){return u.characterCount},destroy(){u.destroyed||(u.destroyed=!0,f=!0)},isDestroyed(){return u.destroyed}}},getBindGroupLayout(M){return I.getBindGroupLayout(M)},updateUniforms(M){const{resolution:F,viewMatrix:u}=M;if(!R||F[0]!==w||F[1]!==G||u!==void 0){const z=new ArrayBuffer(96),C=new Float32Array(z);C[0]=F[0],C[1]=F[1],C[2]=1,C[3]=t.fieldRange??4,C[4]=t.width,C[5]=t.height,C[6]=0,C[7]=0,u?C.set(u,8):(C[8]=1,C[9]=0,C[10]=0,C[11]=0,C[12]=0,C[13]=1,C[14]=0,C[15]=0,C[16]=0,C[17]=0,C[18]=1,C[19]=0,C[20]=0,C[21]=0,C[22]=0,C[23]=1),c.queue.writeBuffer(x,0,z),w=F[0],G=F[1],R=!0}},compact:Z,draw(M,F,u=[]){if(f&&Z(),F.skipUniformUpdate||this.updateUniforms(F),_!==0){M.setPipeline(I),M.setBindGroup(0,D),M.setBindGroup(1,U);for(let B=0;B<u.length;B++)M.setBindGroup(B+2,u[B]);M.draw(4,_)}},getTotalCharacterCount(){return _},destroy(){g.destroy(),x.destroy()}}}const Ot=`
