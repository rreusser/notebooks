import{d as n,_}from"./index-ByB2dbry.js";n({root:document.getElementById("cell-873"),expanded:[],variables:[]},{id:873,body:async()=>{const[{reglCanvas:t},{default:e}]=await Promise.all([_(()=>import("./regl-canvas-Cs3pLjCJ.js"),[]).then(a=>{if(!("reglCanvas"in a))throw new SyntaxError("export 'reglCanvas' not found");return a}),_(()=>import("https://cdn.jsdelivr.net/npm/regl@2.1.1/+esm"),[]).then(a=>{if(!("default"in a))throw new SyntaxError("export 'default' not found");return a})]);return{reglCanvas:t,createREGL:e}},inputs:[],outputs:["reglCanvas","createREGL"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-876"),expanded:[],variables:[]},{id:876,body:(t,e)=>({regl:t.attachResize(e[0],e[1])}),inputs:["_regl","dimensions"],outputs:["regl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-875"),expanded:[],variables:[]},{id:875,body:(t,e,a)=>({_regl:t(e(a,{extensions:["ANGLE_instanced_arrays"]}))}),inputs:["view","reglCanvas","createREGL"],outputs:["_regl"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-391"),expanded:[],variables:[]},{id:391,body:function(e){return e.button("Restart")},inputs:["Inputs"],outputs:void 0,output:"viewof$restart",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-31"),expanded:[],variables:[]},{id:31,body:function(e){return e.range([2,200],{step:1,transform:Math.log,label:"Buckets",value:20})},inputs:["Inputs"],outputs:void 0,output:"viewof$n",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-312"),expanded:[],variables:[]},{id:312,body:function(e){return e.range([1,4],{label:"Friction",value:2.2,transform:Math.log})},inputs:["Inputs"],outputs:void 0,output:"viewof$friction",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-52"),expanded:[],variables:[]},{id:52,body:function(e){return e.range([0,1],{label:"Fill rate",value:.62})},inputs:["Inputs"],outputs:void 0,output:"viewof$fillRate",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-54"),expanded:[],variables:[]},{id:54,body:function(e){return e.range([0,.2],{label:"Drain rate",value:.11,step:.001})},inputs:["Inputs"],outputs:void 0,output:"viewof$drainRate",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-637"),expanded:[],variables:[]},{id:637,body:function(e){return e.select(["Exponential","Constant rate"],{label:"Draining"})},inputs:["Inputs"],outputs:void 0,output:"viewof$drainType",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-355"),expanded:[],variables:[]},{id:355,body:function(e){return e.range([.01,2],{transform:Math.log,label:"Time step",value:.05})},inputs:["Inputs"],outputs:void 0,output:"viewof$dt",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-434"),expanded:[],variables:[]},{id:434,body:function(e){return e.range([.1,10],{transform:Math.log,label:"Fill scale",value:.5})},inputs:["Inputs"],outputs:void 0,output:"viewof$drawScale",assets:void 0,autodisplay:!0,autoview:!0,automutable:!1});n({root:document.getElementById("cell-878"),expanded:[],variables:[]},{id:878,body:(t,e)=>t`The function below defines the derivative function which we integrate to simulate the system. The state variables of the system are the bucket fill amounts as well as the angular position and velocity of the system. For the sake of using an off-the-shelf ODE routine, we pack these into the vector ${e`\mathbf{y}`}. The system itself is just a wheel with inertia, friction, and the moment about the axis of rotation by the buckets.`,inputs:["md","tex"],outputs:[],output:void 0,assets:void 0,autodisplay:!0,autoview:!1,automutable:void 0});n({root:document.getElementById("cell-26"),expanded:[],variables:[]},{id:26,body:(t,e,a,i,o,u,c)=>{function s(d,l,w){const p=l[t],m=l[t+1];let v=1,h=0;for(let r=0;r<t;r++)e?d[r]=-l[r]*a:d[r]=l[r]<0?-l[r]*a:-a,h+=l[r]*Math.sin(p+Math.PI*2*(r/t)),v+=l[r];const b=i(Math.floor(t*i(-p/(2*Math.PI),1)+.5),t);d[b]+=o,u.activeBucket=b,d[t]=m,d[t+1]=(h-m*c)/v}return{derivative:s}},inputs:["n","isExponentialDraining","drainRate","mod","fillRate","mutables","friction"],outputs:["derivative"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-877"),expanded:[],variables:[]},{id:877,body:()=>({mutables:{activeBucket:-1,step:0}}),inputs:[],outputs:["mutables"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-102"),expanded:[],variables:[]},{id:102,body:(t,e,a,i,o,u,c,s,d,l,w,p,m,v,h,b)=>({simulationLoop:function(){const x=t.frame(()=>{let I=10;for(let f=0;f<I;f++)e(a,a,i,o/I);let y=0,g=0;const S=a[u];let E=0;for(let f=0;f<u;f++){const B=S+Math.PI*2*(f/u);y+=a[f]*Math.sin(B),g+=a[f]*Math.cos(B),E+=a[f]}y/=E,g/=E;let k=c(2*s.step,d.length);d[k]=y,d[k+1]=g,l.subdata(d),w.subdata(a),t.clear({color:[1,1,1,1]}),p({y:w,theta:a[u],drawScale:m*(u/15),activeBucket:s.activeBucket}),v({trajectoryScale:.9,cmHistoryBuffer:l,n:Math.min(s.step,d.length/2)}),h([{trajectoryScale:.9,pointSize:7,state:[y,g],color:[.3,.5,.9]},{trajectoryScale:.9,pointSize:4,state:[0,0],color:[0,0,0]}]),s.step=(s.step+1)%(d.length/2)});b.then(()=>x.cancel())}()}),inputs:["regl","odeRK4","y","derivative","dt","n","mod","mutables","centerOfMassHistory","cmHistoryBuffer","yBuffer","drawBuckets","drawScale","drawTrajectory","drawPoint","invalidation"],outputs:["simulationLoop"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-468"),expanded:[],variables:[]},{id:468,body:(t,e)=>{e.step=0},inputs:["restartTrigger","mutables"],outputs:[],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-520"),expanded:[],variables:[]},{id:520,body:(t,e,a,i,o,u)=>({restartTrigger:function(){}()}),inputs:["restart","n","fillRate","drainRate","friction","drainType"],outputs:["restartTrigger"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-643"),expanded:[],variables:[]},{id:643,body:t=>({isExponentialDraining:t==="Exponential"}),inputs:["drainType"],outputs:["isExponentialDraining"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-141"),expanded:[],variables:[]},{id:141,body:(t,e)=>({y:function(){const i=new Float32Array(e+2);return i[e]=Math.PI*2*.5/e-.01,i[e+1]=0,i}()}),inputs:["restart","n"],outputs:["y"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-111"),expanded:[],variables:[]},{id:111,body:(t,e,a)=>({yBuffer:function(){const o=t.buffer(e);return a.then(()=>o.destroy()),o}()}),inputs:["regl","y","invalidation"],outputs:["yBuffer"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-461"),expanded:[],variables:[]},{id:461,body:t=>({centerOfMassHistory:function(){return new Float32Array(2e5)}()}),inputs:["restartTrigger"],outputs:["centerOfMassHistory"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-460"),expanded:[],variables:[]},{id:460,body:(t,e,a)=>({cmHistoryBuffer:function(){const o=t.buffer(e);return a.then(()=>o.destroy()),o}()}),inputs:["regl","centerOfMassHistory","invalidation"],outputs:["cmHistoryBuffer"],output:void 0,assets:void 0,autodisplay:!1,autoview:void 0,automutable:void 0});n({root:document.getElementById("cell-100"),expanded:[],variables:[]},{id:100,body:(t,e)=>{const i=t({vert:`
    ...
    }`,attributes:{uv:{buffer:[[1.06,-.06],[1.06,.94],[-.06,-.06],[-.06,.94]],divisor:0},y:{buffer:t.prop("y"),divisor:1},index:{buffer:new Array(e).fill(0).map((c,s)=>s),divisor:1}},uniforms:{n:e,theta:t.prop("theta"),scale:t.prop("drawScale"),activeBucketIndex:t.prop("activeBucket")},depth:{enable:!1},primitive:"triangle strip",instances:e,count:4}),o=t({vert:`
    precision highp float;
    attribute vec2 xy;
    uniform float scale;
    void main () {
    ...
    }`,attributes:{xy:t.prop("cmHistoryBuffer")},uniforms:{scale:t.prop("trajectoryScale")},blend:{enable:!0,func:{srcRGB:"src alpha",dstRGB:1,srcAlpha:1,dstAlpha:1},equation:{rgb:"reverse subtract",alpha:"add"}},depth:{enable:!1},primitive:"line strip",count:t.prop("n")}),u=t({vert:`
    precision highp float;
