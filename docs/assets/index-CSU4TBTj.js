import{_ as G,d as u}from"./index-Bvdv0JJ6.js";(window.location.hostname==="localhost"||window.location.hostname.match(/127\.0\.0\.1/))&&G(async()=>{const{main:a}=await import("./index-Bvdv0JJ6.js").then(t=>t.i);return{main:a}},[]).then(({main:a})=>{window.__observableRuntime=a,console.log("[DebugClient] Runtime module exposed as window.__observableRuntime"),G(()=>import("./debug-client-BJyqFSh-.js"),[])});u({root:document.getElementById("cell-23"),expanded:[],variables:[]},{id:23,body:(a,t)=>a`The [scalar wave equation](https://en.wikipedia.org/wiki/Wave_equation) in general is given by
